...
use Combodo\nt3\Portal\Form\ObjectFormManager;
...
class ObjectController extends AbstractController
{
	...
	public function ViewAction(Request $oRequest, Application $oApp, $sObjectClass, $sObjectId)
	{
		...
		if ($oRequest->isXmlHttpRequest())
		{
			...
			{
				$oResponse = $oApp['twig']->render('nt3-portal-base/portal/src/views/bricks/object/modal.html.twig', $aData);
			}
			else
			{
		...
		else
		{
			...
			$oResponse = $oApp['twig']->render('nt3-portal-base/portal/src/views/bricks/object/layout.html.twig', $aData);
		}
	...
	public function ApplyStimulusAction(Request $oRequest, Application $oApp, $sObjectClass, $sObjectId, $sStimulusCode)
	{
		...
		if ($oRequest->isXmlHttpRequest())
		{
			...
			{
				$oResponse = $oApp['twig']->render('nt3-portal-base/portal/src/views/modal/mode_loader.html.twig', $aData);
			}
			else
			{
				$oResponse = $oApp->json($aData);
...
//			}
	 ...
	 *
	 * Note: This is inspired from nt3-attachment/ajax.attachment.php
	 * 
	 * @param Request $oRequest
	 * @param Application $oApp
	 */
			...
			case 'add':
				...
				else
				{
					try
					{
						...
						// TODO : Change icon location when nt3-attachment is refactored
						//$aData['icon'] = utils::GetAbsoluteUrlAppRoot() . AttachmentPlugIn::GetFileIcon($oDoc->GetFileName());
						$aData['icon'] = utils::GetAbsoluteUrlAppRoot() . 'env-' . utils::GetCurrentEnvironment() . '/nt3-attachments/icons/image.png';
						$aData['att_id'] = $iAttId;
	 ...
	 * @param \Combodo\nt3\Portal\Controller\DBObject $oObject
