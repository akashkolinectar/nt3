	...
	$.widget( "nt3.hub_installation",
	{
		...
		options:
		{
			...
			labels: {
				...
				rollback: 'NT3 configuration has NOT been modified.'
			}
		},
		...
		{
			this.element
			.removeClass('nt3-hub_installation');
		},
		...
		_on_move_to_prod: function(data)
		{
			if (data.code == 0)
			{
				...
				// Report the installation status to NT3 Hub
		...
		_reportError: function(sMessage)
		{
			...
			$('#hub_start_installation').val('Go Back to NT3');
			$('#hub_start_installation').prop('disabled', false);
