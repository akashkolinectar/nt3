...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-request-mgmt-itil/images/user-request.png',
		...
		MetaModel::Init_DefineHighlightScale( array(
		    'warning' => array('rank' => 1, 'color' => HILIGHT_CLASS_WARNING, 'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-request-mgmt-itil/images/user-request-deadline.png'),
		    'critical' => array('rank' => 2, 'color' => HILIGHT_CLASS_CRITICAL, 'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-request-mgmt-itil/images/user-request-escalated.png'),
		    'closed' => array('rank' => 3, 'color' => HILIGHT_CLASS_NONE, 'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-request-mgmt-itil/images/user-request-closed.png'),
		));
...
// Menus
//
class MenuCreation_nt3_request_mgmt_itil extends ModuleHandlerAPI
{
...
} // class MenuCreation_nt3_request_mgmt_itil
