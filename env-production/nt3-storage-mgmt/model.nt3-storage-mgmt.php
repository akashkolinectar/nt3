...
class StorageSystem extends DatacenterDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/storageArea.png',
		);
...
class SANSwitch extends DatacenterDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/switch-san.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class TapeLibrary extends DatacenterDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/tapelibrary.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class NAS extends DatacenterDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/nas.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class FiberChannelInterface extends NetworkInterface
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/fc-interface.png',
...
class Tape extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/tape.png',
...
class NASFileSystem extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/filesystem.png',
...
class LogicalVolume extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-storage-mgmt/images/volume.png',
