//NT3 Portal Form handler
//This extends nt3.form_handler
;
$(function()
{
	// the widget definition, where 'nt3.portal' is the namespace,
	// 'form_handler' the widget name
	$.widget( 'nt3.portal_form_handler', $.nt3.form_handler,
	{
		options: {
			submit_url: null,
			cancel_url: null
