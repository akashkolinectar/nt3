...
Dict::SetEntries('CS CZ', array(
	...
	'Class:UserInternal+' => 'Uživatel definovaný v NT3',
	...
	'UI:WelcomeMenu:Title' => 'Vítejte v NT3',
	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 je komplexní „opensource” provozní IT portál.</p>
<ul>Obsahuje:
...
<p>Každý modul může být nastaven "krok za krokem" nezávisle na ostatních modulech.</p>',
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 je servisně orientovaný produkt, který umožňuje správcům IT velmi jednoduše spravovat více zákazníků nebo organizací.
<ul>NT3 přináší mnoho dalších výhod umožňujících "optimální" nastavení podnikových procesů které:
...
<p>NT3 je zcela otevřený a umožňuje bezproblémovou integraci s Vaším současným IT systémem pro správu infrastruktury.</p>
<p>
...
<li>Spravovat Vaše nejdůležitější IT aktivum - Dokumentaci.</li>
	...
	'UI:Login:Welcome' => 'Vítejte v NT3!',
	...
	'UI:Login:ForgotPwdForm+' => 'NT3 vám může zaslat instrukce pro obnovení vašeho hesla.',
	...
	'UI:ResetPwd-EmailSubject' => 'Obnovení hesla pro NT3',
	'UI:ResetPwd-EmailBody' => '<body><p>Vyžádali jste obovení hesla pro NT3.</p><p>Pokračujte kliknutím na následující <a href="%1$s">jednorázový odkaz</a> a zadejte nové heslo.</p>',
	...
	'UI:LogOff:ThankYou' => 'Děkujeme za užívání NT3',
	...
	'UI:AccessRO-All' => 'NT3 je pouze ke čtení',
	'UI:AccessRO-Users' => 'NT3 je pouze ke čtení pro koncové uživatele',
	...
	'UI:Title:BulkImport' => 'NT3 - hromadný import',
	...
	'UI:UniversalSearchTitle' => 'NT3 - Univerzální hledání',
	...
	'UI:CSVExport:LostChars+' => 'CSV soubor bude kódován v %1$s. NT3 zjistil, že některé charaktery nejsou s tímto kódováním kompatibilní. Tyto znaky budou nahrazeny zástupným znakem, nebo budou vynechány. Kontaktujte administrátora pro změnu kódování (parametr \'csv_file_default_charset\').',
	...
	'UI:RunQuery:Title' => 'NT3 - Vyhodnocení OQL dotazu',
	...
	'UI:Schema:Title' => 'NT3 schéma objektů',
	...
	'UI:WelcomeTont3' => 'Vítejte v NT3',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - %2$s detaily',
	'UI:ErrorPageTitle' => 'NT3 - Chyba',
	'UI:ObjectDoesNotExist' => 'Tento objekt neexistuje (nebo nemáte oprávnění k jeho zobrazení).',
	'UI:SearchResultsPageTitle' => 'NT3 - Výsledky hledání',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - úprava - %1$s - %2$s',
	'UI:ModificationTitle_Class_Object' => 'Úprava %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - Klonování %1$s - %2$s',
	'UI:CloneTitle_Class_Object' => 'Klonování %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - Vytváření nového objektu (%1$s) ',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - Hromadné odstranění',
	'UI:BulkDeleteTitle' => 'Vyberte objekty, které chcete odstranit:',
	'UI:PageTitle:ObjectCreated' => 'NT3 Objekt vytvořen.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - Závažná chyba',
	'UI:SystemIntrusion' => 'Přístup odepřen. Vyžadujete operaci, která vám není povolena.',
	'UI:FatalErrorMessage' => 'Závažná chyba, NT3 nemůže pokračovat.',
	'UI:Error_Details' => 'Chyba: %1$s',
	'UI:PageTitle:ClassProjections' => 'NT3 správa uživatelů - projekce tříd',
	'UI:PageTitle:ProfileProjections' => 'NT3 správa uživatelů - projekce profilů',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Upozornění v NT3 jsou plně nastavitelné. Jsou založena na dvou druzích objektů: <i>triggery (spouštěče) a akce</i>.</p>
<p><i><b>Triggery</b></i> definují, kdy bude příslušné upozornění spuštěno. V NT3 nalezneme 5 typů triggerů, které pokrývají 3 různé fáze životního cyklu objektu:
<ol>
...
<p>
<i><b>Akce</b></i> definují činnosti, které mají být provedeny, když se triggery spustí. V současné verzi NT3 je definována jedna akce spočívající v zaslání emailové zprávy. Tato akce také definuje šablonu, která se použije pro zasílání emailových zpráv a také pro definici dalších parametrů (příjemci, důležitost apod.).
</p>
...
<p>Aby mohly být akce spuštěny, musí být přiřazeny ke triggerům. Každá akce pak dostane své "pořadové" číslo, které určí v jakém pořadí se akce spustí.</p>',
	...
	'UI:nt3Version:Short' => '%1$s verze %2$s',
	'UI:nt3Version:Long' => '%1$s verze %2$s-%3$s ze dne %4$s',
	...
	'Portal:Title' => 'NT3 uživatelský portál',
	'Portal:NoRequestMgmt' => 'Byli jste přesměrováni na tuto stránku, protože k vašemu účtu je přidělen profil \'Portal user\'. NT3 však nebyl nainstalován s funkcí \'Request Management\'. Kontaktujte prosím vašeho administrátora.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Některé změny nebyly dosud použity. Chcete aby je NT3 zohlednil?',
	...
	'portal:backoffice' => 'NT3 Back-Office',
...
Operátory:<br/>
	...
	'portal:nt3-portal' => 'Standardní portál',
