...
トリガーに関連づけられると、各々のアクションは順番が与えられ、どの順序でアクションが実行されるかが指定されます。</p>',
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'nt3が同期されたアプリケーションを示すハイパーリンク（小さな）イメージ',
	'Class:SynchroDataSource/Attribute:url_application' => 'アプリケーションのハイパーリンク',
	'Class:SynchroDataSource/Attribute:url_application+' => 'nt3が同期化された外部アプリケーションのnt3オブジェクトへのハイパーリンク（該当する場合）。可能なプレースホルダ: $this->attribute$ and $replica->primary_key$',
...
演算子:<br/>
	...
	'Class:UserLocal' => 'nt3ユーザー',
	'Class:UserLocal+' => 'nt3ローカル認証ユーザー',
	...
	'Class:lnkFunctionalCnt3roviderContract' => 'リンク 機能的CI/プロバイダー契約',
	'Class:lnkFunctionalCnt3roviderContract+' => '',
	'Class:lnkFunctionalCnt3roviderContract/Attribute:providercontract_id' => 'プロバイダー契約',
	...
	'Class:lnkFunctionalCnt3roviderContract/Attribute:providercontract_name' => 'プロバイダー契約名',
	'Class:lnkFunctionalCnt3roviderContract/Attribute:providercontract_name+' => '',
	'Class:lnkFunctionalCnt3roviderContract/Attribute:functionalci_name' => 'CI名',
