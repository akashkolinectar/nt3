...
Dict::SetEntries('DE DE', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Ein (kleines) Bild verlinken, das die Applikation repräsentiert, mit der NT3 synchronisiert wird',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hyperlink zur Applikation',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink zum NT3 Objekt in der externen Applikation mit der NT3 synchronisiert wird (falls anwendbar). Mögliche Platzhalter: $this->attribute$ und $replica->primary_key$',
...
Wenn Aktionen mit Trigger verknüpft sind, bekommt jede Aktion eine Auftragsnummer, die die Reihenfolge der auszuführenden Aktionen festlegt.</p>',
	...
	'Class:UserExternal+' => 'Benutzer außerhalb von NT3',
	'Class:UserLocal' => 'NT3-Benutzer',
	'Class:UserLocal+' => 'Benutzer, von NT3 authentifiziert',
