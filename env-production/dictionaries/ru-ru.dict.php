...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'Attachments:UploadNotAllowedOnThisSystem' => 'Загрузка файлов НЕ разрешена в этой системе. За подробностями обратитесь к администратору вашего NT3',
	...
	'portal:nt3-portal' => 'Пользовательский портал',
