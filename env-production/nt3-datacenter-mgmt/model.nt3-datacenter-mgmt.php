...
/**
 * Classes and menus for nt3-datacenter-mgmt (version 2.5.0)
 */
...
class Rack extends PhysicalDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-datacenter-mgmt/images/rack.png',
		);
...
class Enclosure extends PhysicalDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-datacenter-mgmt/images/enclosure.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
abstract class PowerConnection extends PhysicalDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-datacenter-mgmt/images/power-connection.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class PDU extends PowerConnection
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-datacenter-mgmt/images/pdu.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
