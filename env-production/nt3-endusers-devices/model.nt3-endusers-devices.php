...
// File generated by ... on the 2018-10-03T14:16:22+0200
...
class PC extends ConnectableCI
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/laptop.png',
		);
...
class Printer extends ConnectableCI
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/printer.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
abstract class TelephonyCI extends PhysicalDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/mobile-phone.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class Phone extends TelephonyCI
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/phone.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class IPPhone extends TelephonyCI
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/ipphone.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class Tablet extends PhysicalDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/tablet.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class Peripheral extends PhysicalDevice
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-endusers-devices/images/peripherals.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
