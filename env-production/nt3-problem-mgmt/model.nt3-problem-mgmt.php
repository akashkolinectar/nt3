...
class Problem extends Ticket
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-problem-mgmt/images/problem.png',
...
// Menus
//
class MenuCreation_nt3_problem_mgmt extends ModuleHandlerAPI
{
...
} // class MenuCreation_nt3_problem_mgmt
