...
class KnownError extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-knownerror-mgmt/images/known-error.png',
		);
...
class lnkDocumentToError extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'link_id',
			'db_finalclass_field' => '',
			'display_template' => utils::GetAbsoluteUrlModulesRoot().'nt3-knownerror-mgmt/../business/templates/default.html',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
class FAQ extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		(
			...
			'db_key_field' => 'id',
			'db_finalclass_field' => '',
			'icon' => utils::GetAbsoluteUrlModulesRoot().'nt3-knownerror-mgmt/images/faq.png',
		);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
...
// Menus
//
class MenuCreation_nt3_knownerror_mgmt extends ModuleHandlerAPI
{
...
} // class MenuCreation_nt3_knownerror_mgmt
