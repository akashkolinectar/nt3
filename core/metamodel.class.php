 ...
 * it should not be edited inside NT3 anymore
 *
 * @package     nt3ORM
 */
...
abstract class MetaModel
{
	...
	public static function EnumChildClasses($sClass, $iOption = ENUM_CHILD_CLASSES_EXCLUDETOP)
	{
		...
		if($sClass=='FunctionalCI'){			
			foreach($aRes as $k=>$v){
				switch($k){
					case 0: case 1: case 2: case 4; case 7: case 18: case 22: case 23: case 24: case 26: case 27: 
					case 28: case 29: case 30: case 31: case 35: case 36: case 38: case 12: case 17: case 19: case 37: case 15: case 10: break;
					default: array_push($newarr, $v); break;
				}
			}
			$aRes = $newarr;			
		}
	...
	public static function DBCheckFormat()
	{
		...
		foreach(self::GetClasses() as $sClass)
		{
			...
			foreach(self::ListAttributeDefs($sClass) as $sAttCode => $oAttDef)
			{
				...
				{
					// Keep track of columns used by NT3
...
//		}
	...
	public static function LoadConfig($oConfiguration, $bAllowCache = false)
	{
		...
		$sAppIdentity = 'nt3-'.MetaModel::GetEnvironmentId();
		...
		if (self::$m_bUseAPCCache)
		{
			...
			//
			$sOqlAPCCacheId = 'nt3-'.MetaModel::GetEnvironmentId().'-metamodel';
	...
	public static function GetHyperLink($sTargetClass, $iKey)
	{
		...
		if (is_null($oObj))
		{
			...
			$oRecord = $oSet->Fetch();
			// An empty fname is obtained with NT3 < 2.0
			...
			return '<span class="nt3-deleted-object" title="'.htmlentities($sTitle, ENT_QUOTES, 'UTF-8').'">'.htmlentities($sName, ENT_QUOTES, 'UTF-8').'</span>';
		}
	...
	public static function ResetCache($sEnvironmentId = null)
	{
		...
		$sAppIdentity = 'nt3-'.$sEnvironmentId;
