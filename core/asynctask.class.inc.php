...
abstract class AsyncTask extends DBObject
{
	public static function Init()
	{
		...
		// Null is allowed to ease the migration from NT3 2.0.2 and earlier, when the status did not exist, and because the default value is not taken into account in the SQL definition
