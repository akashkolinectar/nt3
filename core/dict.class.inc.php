...
class Dict
{
	...
	public static function S($sStringCode, $sDefault = null, $bUserLanguageOnly = false)
	{
		...
		{	
			/*** Make Mo to Mb in attachment Edited by Nilesh ***/	
			if($sStringCode == "Attachment:Max_Mo"){
				/*echo "<pre>";
				var_dump($aCurrentDictionary[$sStringCode]);
				echo array_key_exists($sStringCode, $aCurrentDictionary);*/
				return str_replace('Mo', 'Mb', $aCurrentDictionary[$sStringCode]);
	...
	public static function Format($sFormatCode /*, ... arguments ....*/)
	{
		...
		//echo "<pre>";
		/*var_dump($sLocalizedFormat);*/
		//echo strpos($sLocalizedFormat, 'Maximum file size:');
		if(strpos($sLocalizedFormat, 'Maximum file size:') !== false){
			str_replace("Mo", "MB", $sLocalizedFormat);
		}
	 ...
	 * @param string $sApplicationPrefix The prefix for uniquely identiying this NT3 instance
	 */
