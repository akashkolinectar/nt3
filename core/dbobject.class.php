...
abstract class DBObject implements iDisplay
{
	...
	public function CheckValue($sAttCode, $value = null)
	{
		...
		elseif ($oAtt->IsNull($toCheck))
		{
			...
			/********** EOF Modified by Nilesh New for remove mandatory description ***********/
	...
	// Note: this is experimental - it was designed to speed up the setup of NT3
	// Known limitations:
	...
	*/	
	...
	static protected $aPortalToURLMaker = array('console' => 'nt3StandardURLMaker', 'portal' => 'PortalURLMaker');
