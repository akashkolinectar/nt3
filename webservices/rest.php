...
try
{
	...
	$iRet = LoginWebPage::DoLogin(false, false, LoginWebPage::EXIT_RETURN); // Starting with NT3 2.2.0 portal users are no longer allowed to access the REST/JSON API
