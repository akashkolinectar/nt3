...
$sConfigFile = APPCONF.nt3_DEFAULT_ENV.'/'.nt3_CONFIG_FILE;
if (!file_exists($sConfigFile))
{
	echo "NT3 is not yet installed. Exiting...\n";
...
if (utils::IsModeCLI())
{
	$oP = new CLIPage("nt3 - CRON");
}
else
{
	$oP = new WebPage("nt3 - CRON");
}
