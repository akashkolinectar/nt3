...
<definitions name="nt3" targetNamespace="urn:nt3" xmlns:typens="urn:nt3" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns="http://schemas.xmlsoap.org/wsdl/">
	<types>
		<xsd:schema xmlns="http://www.w3.org/2001/XMLSchema" targetNamespace="urn:nt3">
	...
	<portType name="WebServicePortType">
		<operation name="GetVersion">
			<!-- wsdl:documentation>
				Get the current version of nt3
	...
	<binding name="WebServiceBinding" type="typens:WebServicePortType">
		...
		<operation name="GetVersion">
			...
			<input>
				<soap:body namespace="urn:nt3" use="encoded" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
			</input>
			<output>
				<soap:body namespace="urn:nt3" use="encoded" encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"/>
			</output>
	...
	<service name="nt3Service">
		<!-- wsdl:documentation>
			nt3 is the central solution for managing your IT infrastructure
		</wsdl:documentation -->
