...
function Usage(Page $oP)
{
	if (Utils::IsModeCLI())
	{
		...
		$oP->p("Parameters:");
		$oP->p(" * auth_user: the NT3 user account for authentication");
		$oP->p(" * auth_pwd: the password of the NT3 user account");
	}
	else
	{
		$oP->p("Parameters:");
