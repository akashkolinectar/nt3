//NT3 Designer widget for editing properties line by line
$(function()
{
	// the widget definition, where "nt3" is the namespace,
	// "property_field" the widget name
	$.widget( "nt3.property_field",
	{
		// default options
		options:
		{
		...
		{	
			...
			this.element
				.addClass( "nt3-property-field" )
				.bind('apply_changes.nt3-property-field', function(){me._do_apply();} );
			...
			if (this.options.field_id != '')
			{
				...
				$('#'+this.options.field_id, this.element).bind('change.nt3-property-field keyup.nt3-property-field', function() { me._on_change(); });
				this.value = this._get_field_value();
			}
			this.element.find(".prop_apply").bind('click.nt3-property-field', function() { me._do_apply(); });
			this.element.find(".prop_cancel").bind('click.nt3-property-field', function() { me._do_cancel(); });
		...
		_refresh: function()
		{
			if (this.bModified)
			{
				this.element.addClass("nt3-property-field-modified");
			...
			{
				this.element.removeClass("nt3-property-field-modified");
				this.element.find(".prop_icon span.ui-icon-circle-check").css({visibility: 'hidden'});
		...
		_destroy: function()
		{
			this.element.removeClass( "nt3-property-field" );
			this.element.removeClass("nt3-property-field-modified");
		},
		...
		_do_submit: function()
		{
			...
			this.element.closest('form').find('.nt3-property-field').each(function()
			{
		...
		{
			var oWidget = element.data('nt3Property_field');
			if (oWidget == undefined)
			{
				oWidget = element.data('nt3Selector_property_field');
			}
			return oWidget;
		}
	});
...
$(function()
{
	...
	$.widget( "nt3.selector_property_field", $.nt3.property_field,
	{
		// default options
		options:
		{
		...
		{	
			...
			this.element
				.addClass( "nt3-selector-property-field" );
		...
		_update_subform: function()
		{
			...
			$('tr[data-path^="'+sSelector+'"]').each(function() {
				if($(this).is(':visible'))
				{
					var oWidget = me._get_widget($(this).closest('.nt3-property-field'));
					if (oWidget)
					{
						try
						{
		...
		_destroy: function()
		{
			this.element.removeClass( "nt3-selector-property-field" );
			this._superApply();
		},
		_on_change: function()
		{
