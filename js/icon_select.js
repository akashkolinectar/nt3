...
$(function()
{
	...
	$.widget( "nt3.icon_select",
	{
		...
		{	
			...
			this.element.addClass( "nt3-icon-select" ).button();
			this.element.bind( "reverted.nt3-icon-select", function(ev, data) {
			...
			$('#event_bus').bind('tabshow.nt3-icon-select'+id, function(event) {
		...
		_destroy: function()
		{
			this.element.removeClass( "nt3-icon-select" );
