/**
 *
 * NT3 Search form history handler
 *
 * the widget exposes
 *
 * $(cssSelector).search_form_handler_history({"nt3_root_class":"FooBarClass"}) : constructor
 ...
 *
 *
 * The persistence layer rely on these two core NT3's JS functions :
...
$(function()
{
	...
	$.widget( 'nt3.search_form_handler_history',
	{
		// default options
		options:
		{
		...
		_create: function()
		{
			...
			{
				me.options.preference_code = me.options.nt3_root_class + '__search_history';
			}
