...
function ReportFieldValidationStatus(sFieldId, sFormId, bValid, sExplain)
{
	...
	else
	{
		...
		// Visual feedback
		/* Edited by nilesh to remove specify value mandatory */
		$('#v_'+sFieldId).html('<img src="../images/validation_error.png" style="vertical-align:middle" title="'+sExplain+'"/>');  //  data-tooltip="'+sExplain+'"
