	...
	$.widget( 'nt3.breadcrumb',
	{
		...
		_create: function()
		{
			...
			if(typeof(Storage) !== "undefined")
			{
				...
				$('#nt3-breadcrumb').html(sBreadCrumbHtml);
			}
			else
			{
				// Sorry! No Web Storage support..
				//$('#nt3-breadcrumb').html('<span style="display:none;">Session storage not available for the current browser</span>');
			}
		},
		...
		_Read: function()
		{
			var sBreadCrumbStorageKey = this.options.nt3_instance_id + 'breadcrumb-v1';
			var aBreadCrumb = [];
		...
		RefreshLatestEntry: function(sRefreshHrefTo)
		{
			...
			if (this.options.new_entry !== null) {
				...
				$('#nt3-breadcrumb .breadcrumb-current:last-of-type a').attr('href', sRefreshHrefTo);
			}
			this._Write(aBreadCrumb);
		},
