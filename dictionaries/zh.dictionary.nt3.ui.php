...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'BooleanLabel:yes' => '是',
	'BooleanLabel:no' => '否',
	'Menu:WelcomeMenu' => '欢迎', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => '欢迎来到nt3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => '欢迎', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => '欢迎来到nt3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => '欢迎来到nt3',

	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 是完全的, 开发源码的, IT 操作门户.</p>
<ul>系统包括:
...
<p>所有模块可以各自独立地、一步一步地搭建.</p>',
	...
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 是面向服务提供商的, 它使得 IT 工程师方便地管理多客户和多组织.
<ul>NT3, 提供功能丰富的业务处理流程:
<li>提高 IT 管理效率</li> 
<li>驱动 IT 操作能力</li> 
<li>提高用户满意度,从业务能力方面提供执行力.</li>
</ul>
</p>
<p>NT3 是完全开放的,可被集成到您当前的IT管理架构中.</p>
<p>
...
<li>管理您的 IT 中最重要的设施: 文档化.</li>
	...
	'UI:LogOffMenu' => '注销',
	'UI:LogOff:ThankYou' => '谢谢使用nt3',
	'UI:LogOff:ClickHereToLoginAgain' => '点击这里再次登录...',
	'UI:ChangePwdMenu' => '改变密码...',
	'UI:Login:RetypePwdDoesNotMatch' => '新密码和重录的新密码不符!',
	'UI:Button:Login' => '进入 NT3',
	'UI:Login:Error:AccessRestricted' => 'NT3 访问被限制. 请联系nt3系统管理员.',
	'UI:Login:Error:AccessAdmin' => '有系统管理员权限才能访问. 请联系nt3系统管理员.',
	...
	'UI:RunQuery:Title' => 'NT3 - OQL 查询评估',
...
//	'UI:Delete:MustBeDeletedManuallyButNotPossible' => '必须手工删除 - 但您未被允许删除该对象, 请联系您的应用程序系统管理员',
	...
	'UI:WelcomeTont3' => '欢迎来到 NT3',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - %2$s 详细内容',
	'UI:ErrorPageTitle' => 'NT3 - 错误',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - 搜索结果',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - %1$s - %2$s 修改',
	'UI:ModificationTitle_Class_Object' => '修改 %1$s: <span class=\"hilite\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - 克隆 %1$s - %2$s 修改',
	'UI:CloneTitle_Class_Object' => '克隆 %1$s: <span class=\"hilite\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - 创建一个新的 %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - 批量删除',
	'UI:BulkDeleteTitle' => '选择您要删除的对象:',
	'UI:PageTitle:ObjectCreated' => 'NT3 对象创建了.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - 致命错误',
	'UI:SystemIntrusion' => '访问被禁止. 您正尝试未被许可的操作.',
	'UI:FatalErrorMessage' => '致命错误, NT3 无法继续.',
	'UI:Error_Details' => '错误: %1$s.',

	'UI:PageTitle:ClassProjections'	=> 'NT3 用户管理 - 类投射',
	'UI:PageTitle:ProfileProjections' => 'NT3 用户管理 - 简档投射',
	...
	'Menu:AdminTools' => '管理工具', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => '管理工具', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => '具有系统管理员简档的用户才能获得的工具', // Duplicated into nt3-welcome-itil (will be removed from here...)
...
'UI-ServiceManagementOverview-ProviderContractToRenew' => '供应商联系人需在30日内更新',
	...
	'Menu:CSVImportMenu' => 'CSV 导入', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:CSVImportMenu+' => '大批量创建或修改', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:DataModelMenu' => '数据模型', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu+' => '数据模型概览', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:ExportMenu' => '导出', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu+' => '以HTML, CSV or XML格式导出任何查询的结果', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:NotificationsMenu' => '通知', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu+' => '通知的配置', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:NotificationsMenu:Title' => '配置 <span class="hilite">通知</span>',
	'UI:NotificationsMenu:Help' => '帮助',
	'UI:NotificationsMenu:HelpContent' => '<p>在 NT3 中, 通知可以被完全客户化定制. 它们是基于两个对象集: <i>触发器和动作</i>.</p>
...
当与一个触发器关联时, 每个动作都被赋予一个顺序号, 规定了按什么样的顺序执行这些动作.</p>',
	...
	'Menu:AuditCategories' => '审计类目', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => '审计类目', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => '审计类目', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:RunQueriesMenu' => '运行查询', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => '运行任何查询', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:DataAdministration' => '数据管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => '数据管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:UniversalSearchMenu' => '通用搜索', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => '搜索所有...', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:UserManagementMenu' => '用户管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => '用户管理', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:ProfilesMenu' => '简档', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => '简档', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => '简档', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:UserAccountsMenu' => '用户帐户', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => '用户帐户', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => '用户帐户',	 // Duplicated into nt3-welcome-itil (will be removed from here...)
