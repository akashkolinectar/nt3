...
Dict::Add('CS CZ', 'Czech', 'Čeština', array(
    ...
    'Class:SynchroDataSource/Attribute:url_icon+' => 'Hypertextový odkaz na ikonu reprezentující aplikaci, se kterou je NT3 synchronizovnán',
    'Class:SynchroDataSource/Attribute:url_application' => 'Aplikace',
    'Class:SynchroDataSource/Attribute:url_application+' => 'Hypertextový odkaz na NT3 objekt v externí aplikaci, se kterou je NT3 synchronizován (pokud je to relevantní). Možné zástupné symboly: $this->attribute$ a $replica->primary_key$',
