...
Dict::Add('JA JP', 'Japanese', '日本語', array(
	...
	'BooleanLabel:yes' => 'はい',
	'BooleanLabel:no' => 'いいえ',
	'Menu:WelcomeMenu' => 'ようこそ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => 'ようこそ、nt3へ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'ようこそ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => 'ようこそ、nt3へ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'ようこそ、nt3へ',
	'UI:WelcomeMenu:LeftBlock' => '<p>nt3は、オープンソースの、完結したIT運用ポータルです。</p>
<ul>以下を含みます。
...
<p>すべてのモジュールはお互いに独立しており、別個にセットアップが可能です。</p>',
	'UI:WelcomeMenu:RightBlock' => '<p>nt3はサービスプロバイダ志向であり、ITエンジニアが複数の顧客や組織を簡単に管理できるようになります。
<ul>nt3は、機能豊富な下記のビジネスプロセスのセットを提供します。
<li>IT管理の実効性の強化。</li>
<li>IT運用効率化の推進。</li>
<li>顧客満足度の改善と、業績への洞察を経営経営幹部へ提供。</li>
</ul>
</p>
<p>nt3は完全にオープンなので、あなたが今使っているIT管理インフラとの統合が可能です。</p>
<p>
...
<li>ITの中でもっとも重要な財産である「文書化」の管理。</li>
	...
	'UI:LogOffMenu' => 'ログオフ',
	'UI:LogOff:ThankYou' => 'nt3をご利用いただき、ありがとうございます。',
	'UI:LogOff:ClickHereToLoginAgain' => '再度ログインするにはここをクリックしてください...',
	'UI:ChangePwdMenu' => 'パスワードを変更する...',
	'UI:Login:PasswordChanged' => 'パスワードは変更されました。',
	'UI:AccessRO-All' => 'nt3は参照専用です。',
	'UI:AccessRO-Users' => 'エンドユーザの方はnt3は参照専用です。',
	'UI:ApplicationEnvironment' => 'アプリケーション環境: %1$s',
	'UI:Login:RetypePwdDoesNotMatch' => '2度入力された新しいパスワードが一致しません!',
	'UI:Button:Login' => 'nt3へ入る',
	'UI:Login:Error:AccessRestricted' => 'nt3へのアクセスは制限されています。nt3管理者に問い合わせしてください。',
	'UI:Login:Error:AccessAdmin' => '管理者権限をもつユーザにアクセスが制限されています。nt3管理者に問い合わせしてください。',
	...
	'UI:Title:BulkImport' => 'NT3 - バルクインポート',
	...
	'UI:UniversalSearchTitle' => 'NT3 - ユニバーサル検索',
	...
	'UI:CSVExport:LostChars+' => 'ダウンロードファイルは %1$s でエンコードされます. NT3 はこのフォーマットと整合性のない文字を検出しました。 これらの文字は代りの文字になります。（たとえばアクセント付き文字からはアクセント記号が無くなります。または、削除されます。 Webブラウザからコピー／ペーストが出来ます。 あるいは、システム管理者にエンコードの変更を問い合わせください。 (See parameter \'csv_file_default_charset\').',
	'UI:Audit:Title' => 'NT3 - CMDB 監査',
	...
	'UI:RunQuery:Title' => 'NT3 - OQLクエリ評価',
	...
	'UI:Schema:Title' => 'NT3 オブジェクトスキーマ',
	...
	'UI:WelcomeTont3' => 'nt3へようこそ',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - %2$sの詳細',
	'UI:ErrorPageTitle' => 'NT3 - エラー',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - 検索結果',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - %1$s - %2$s 修正',
	'UI:ModificationTitle_Class_Object' => '%1$sの修正： <span class=\"hilite\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - クローン%1$s - %2$s 修正',
	'UI:CloneTitle_Class_Object' => '%1$sのクローン：<span class=\"hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - 新規%1$sを作成',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - バルク削除',
	'UI:BulkDeleteTitle' => '削除するオブジェクトを選択してください。',
	'UI:PageTitle:ObjectCreated' => 'nt3オブジェクトが作成されました。',
	...
	'UI:PageTitle:FatalError' => 'NT3 - 致命的なエラー',
	'UI:SystemIntrusion' => 'アクセスが拒否されました。あなたが許可されていない操作を実行しようとしています。',
	'UI:FatalErrorMessage' => '致命的なエラー、nt3を続行することはできません。',
	'UI:Error_Details' => 'エラー：%1$s',
	'UI:PageTitle:ClassProjections' => 'NT3 ユーザ管理 - クラスプロジェクション',
	'UI:PageTitle:ProfileProjections' => 'NT3 ユーザ管理 - プロフィールプロジェクション',
	...
	'Menu:AdminTools' => '管理ツール', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => '管理ツール', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => 'このツールは管理者プロフィールを持つユーザのみアクセスが可能です。', // Duplicated into nt3-welcome-itil (will be removed from here...)
	...
	'Menu:CSVImportMenu' => 'CSV インポート', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:CSVImportMenu+' => '一括作成/一括更新', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu' => 'データモデル', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu+' => 'データモデル概要', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu' => 'エクスポート', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu+' => '任意のクエリ結果をHTML、CSV、XMLでエクスポートする', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu' => '通知', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu+' => '通知の設定', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:NotificationsMenu:Title' => '<span class="hilite">通知</span>の設定',
	'UI:NotificationsMenu:Help' => 'ヘルプ',
	'UI:NotificationsMenu:HelpContent' => '<p>nt3では、通知はすべてカスタマイズが可能です。通知は<i>トリガーとアクション</i>という二つのオブジェクトがベースになっています。
...
トリガーに関連づけられると、各々のアクションは順番が与えられ、どの順序でアクションが実行されるかが指定されます。</p>',
	...
	'Menu:AuditCategories' => '監査カテゴリ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => '監査カテゴリ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => '監査カテゴリ', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu' => 'クエリ実行', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => '任意のクエリを実行', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu' => 'クエリのフレーズブック', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'クエリのフレーズブック', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration' => 'データ管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => 'データ管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu' => '全検索', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => '何か...検索', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu' => 'ユーザ管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => 'ユーザ管理', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu' => 'プロフィール', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => 'プロフィール', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'プロフィール', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu' => 'ユーザアカウント', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => 'ユーザアカウント', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'ユーザアカウント', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:nt3Version:Short' => '%1$sバージョン%2$s',
	'UI:nt3Version:Long' => '%1$sバージョン%2$s-%3$s ビルド%4$s',
	...
	'Portal:Title' => 'nt3ユーザポータル',
	'Portal:NoRequestMgmt' => '%1$s さん, このページにリダイレクトされました。あなたのプロファイルは、「ポータルユーザ」として登録されています。残念ながら、NT3 は、「要求管理」としてインストールされていません。管理者に問い合わせてください。',
	...
	'Menu:MyShortcuts' => '私のショートカット', // Duplicated into nt3-welcome-itil (will be removed from here...)
