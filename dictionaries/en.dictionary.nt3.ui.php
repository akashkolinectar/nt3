...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:UserInternal+' => 'User defined within NT3',
));
...
Dict::Add('EN US', 'English', 'English', array(
	...
	'BooleanLabel:no' => 'no',
    'UI:Login:Title' => 'NT3 login',
	'Menu:WelcomeMenu' => 'Welcome', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => 'Welcome to NT3', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'Welcome', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => 'Welcome to NT3', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'Welcome to NT3',

	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 is a IT Operational Portal.</p>
<ul>It includes:
...
<p>All the modules can be setup, step by step, indepently of each other.</p>',
	...
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 is service provider oriented, it allows IT engineers to manage easily multiple customers or organizations.
<ul>NT3, delivers a feature-rich set of business processes that:
...
<p>NT3 is completely open to be integrated within your current IT Management infrastructure.</p>
<p>
...
<li>Manage the most important asset of your IT: Documentation.</li>
	...
	'UI:Error:UploadedFileTooBig' => 'The uploaded file is too big. (Max allowed size is %1$s). To modify this limit, contact your NT3 administrator. (Check the PHP configuration for upload_max_filesize and post_max_size on the server).',
	...
	'UI:Login:Welcome' => 'Welcome to NT3!',
	...
	'UI:Login:ForgotPwdForm+' => 'NT3 can send you an email in which you will find instructions to follow to reset your account.',
	...
	'UI:ResetPwd-EmailSubject' => 'Reset your NT3 password',
	'UI:ResetPwd-EmailBody' => '<body><p>You have requested to reset your NT3 password.</p><p>Please follow this link (single usage) to <a href="%1$s">enter a new password</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Thank you for using NT3',
	...
	'UI:AccessRO-All' => 'NT3 is read-only',
	'UI:AccessRO-Users' => 'NT3 is read-only for end-users',
	...
	'UI:Login:Error:AccessRestricted' => 'NT3 access is restricted. Please, contact an NT3 administrator.',
	'UI:Login:Error:AccessAdmin' => 'Access restricted to people having administrator privileges. Please, contact an NT3 administrator.',
	...
	'UI:Title:BulkImport' => 'NT3 - Bulk import',
	...
	'UI:UniversalSearchTitle' => 'NT3 - Universal Search',
	...
	'UI:CSVExport:LostChars+' => 'The downloaded file will be encoded into %1$s. NT3 has detected some characters that are not compatible with this format. Those characters will either be replaced by a substitute (e.g. accentuated chars losing the accent), or they will be discarded. You can copy/paste the data from your web browser. Alternatively, you can contact your administrator to change the encoding (See parameter \'csv_file_default_charset\').',

	'UI:Audit:Title' => 'NT3 - CMDB Audit',
	...
	'UI:RunQuery:Title' => 'NT3 - OQL Query Evaluation',
	...
	'UI:Query:UrlV1' => 'The list of fields has been left unspecified. The page <em>export-V2.php</em> cannot be invoked without this information. Therefore, the URL suggested here below points to the legacy page: <em>export.php</em>. This legacy version of the export has the following limitation: the list of exported fields may vary depending on the output format and the data model of NT3. <br/>Should you want to garantee that the list of exported columns will remain stable on the long run, then you must specify a value for the attribute "Fields" and use the page <em>export-V2.php</em>.',
	'UI:Schema:Title' => 'NT3 objects schema',
	...
	'UI:WelcomeToNT3' => 'Welcome to NT3',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - %2$s details',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - Search Results',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - %1$s - %2$s modification',
	'UI:ModificationTitle_Class_Object' => 'Modification of %1$s: <span class=\"hilite\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - Clone %1$s - %2$s modification',
	'UI:CloneTitle_Class_Object' => 'Clone of %1$s: <span class=\"hilite\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - Creation of a new %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - Bulk Delete',
	'UI:BulkDeleteTitle' => 'Select the objects you want to delete:',
	'UI:PageTitle:ObjectCreated' => 'NT3 Object Created.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - Fatal Error',
	'UI:SystemIntrusion' => 'Access denied. You have requested an operation that is not allowed for you.',
	'UI:FatalErrorMessage' => 'Fatal error, NT3 cannot continue.',
	'UI:Error_Details' => 'Error: %1$s.',

	'UI:PageTitle:ClassProjections'	=> 'NT3 user management - class projections',
	'UI:PageTitle:ProfileProjections' => 'NT3 user management - profile projections',
	...
	'Menu:AdminTools' => 'Admin tools', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => 'Administration tools', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => 'Tools accessible only to users having the administrator profile', // Duplicated into NT3-welcome-itil (will be removed from here...)
...
'UI-ServiceManagementOverview-ProviderContractToRenew' => 'Provider contracts to be renewed in 30 days',
	...
	'Menu:CSVImportMenu' => 'CSV import', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:CSVImportMenu+' => 'Bulk creation or update', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:DataModelMenu' => 'Data Model', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu+' => 'Overview of the Data Model', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:ExportMenu' => 'Export', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu+' => 'Export the results of any query in HTML, CSV or XML', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:NotificationsMenu' => 'Notifications', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu+' => 'Configuration of the Notifications', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'UI:NotificationsMenu:Title' => 'Configuration of the <span class="hilite">Notifications</span>',
	'UI:NotificationsMenu:Help' => 'Help',
	'UI:NotificationsMenu:HelpContent' => '<p>In NT3 the notifications are fully customizable. They are based on two sets of objects: <i>triggers and actions</i>.</p>
...
When associated with a trigger, each action is given an "order" number, specifying in which order the actions are to be executed.</p>',
	...
	'Menu:AuditCategories' => 'Audit Categories', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => 'Audit Categories', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => 'Audit Categories', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:RunQueriesMenu' => 'Run Queries', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => 'Run any query', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:QueryMenu' => 'Query phrasebook', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'Query phrasebook', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:DataAdministration' => 'Data administration', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => 'Data administration', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:UniversalSearchMenu' => 'Universal Search', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => 'Search for anything...', // Duplicated into NT3-welcome-itil (will be removed from here...)
	
	'Menu:UserManagementMenu' => 'User Management', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => 'User management', // Duplicated into NT3-welcome-itil (will be removed from here...)

	'Menu:ProfilesMenu' => 'Profiles', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => 'Profiles', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'Profiles', // Duplicated into NT3-welcome-itil (will be removed from here...)

	'Menu:UserAccountsMenu' => 'User Accounts', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => 'User Accounts', // Duplicated into NT3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'User Accounts', // Duplicated into NT3-welcome-itil (will be removed from here...)	

	'UI:NT3Version:Short' => '%1$s version %2$s',
	'UI:NT3Version:Long' => '%1$s version %2$s-%3$s built on %4$s',
	...
	'Portal:Title' => 'NT3 user portal',
	'Portal:NoRequestMgmt' => 'Dear %1$s, you have been redirected to this page because your account is configured with the profile \'Portal user\'. Unfortunately, NT3 has not been installed with the feature \'Request Management\'. Please contact your administrator.',
	...
	'UI:AutoApplyConfirmationMessage' => 'Some changes have not been applied yet. Do you want NT3 to take them into account?',
	...
	'Menu:MyShortcuts' => 'My Shortcuts', // Duplicated into NT3-welcome-itil (will be removed from here...)
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'About NT3...',
	'UI:About:Title' => 'About NT3',
	...
	'portal:backoffice' => 'NT3 Back-Office User Interface',
