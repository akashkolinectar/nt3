...
Dict::Add('IT IT', 'Italian', 'Italiano', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Una (piccola) immagine del collegamento ipertestuale che rappresenta l\'applicazione con cui è sincronizzato Qnt3',
	'Class:SynchroDataSource/Attribute:url_application' => 'Collegamento ipertestuale all\'applicazione',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Collegamento ipertestuale all\'oggetto nt3 nell\'applicazione esterna con la quale Qnt3 è sincronizzato (se applicabile). Possibili segnaposto: $this->attribute$ e $replica->primary_key$',
	...
	'Menu:DataSources' => 'Sorgente di sincronizzazione dei dati', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataSources+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
