...
Dict::Add('RU RU', 'Russian', 'Русский', array(
	...
	'Class:UserInternal+' => 'Учетная запись создана внутри NT3',
));
...
Dict::Add('RU RU', 'Russian', 'Русский', array(
	...
	'Menu:WelcomeMenu+' => 'Добро пожаловать в NT3',
	'Menu:WelcomeMenuPage' => 'Добро пожаловать',
	'Menu:WelcomeMenuPage+' => 'Добро пожаловать в NT3',
	'UI:WelcomeMenu:Title' => 'Добро пожаловать в NT3',

	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 является порталом оперативного централизованного управления IT инфраструктурой с открытым исходным кодом.</p>
<ul>Он включает:
...
<p>Все модули могут быть настроены, шаг за шагом, независмо друг от друга.</p>',
	...
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 ориентирован на предоставления сервисов, он позволяет IT специалистам легко управляться с несколькими заказчиками или организациями.
<ul>NT3 обеспечивает многофункциональный набор бизнес-процессов, которые:
...
<p>NT3 полностью открыт для интеграции в рамках текущего управления ИТ-инфраструктурой.</p>
<p>
...
<li>Управлять наиболее важным активом ИТ: документацией.</li>
	...
	'UI:Login:Welcome' => 'Добро пожаловать в NT3!',
	...
	'UI:Login:ForgotPwdForm+' => 'Введите свой логин для входа в систему и нажмите "Отправить". NT3 отправит email с инструкциями по восстановлению пароля на ваш электронный адрес.',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Вы запросили восстановление пароля NT3.</p><p>Пожалуйста, воспользуйтесь <a href="%1$s">этой ссылкой</a> для задания нового пароля.</p></body>',
	...
	'UI:LogOffMenu' => 'Выход',
	'UI:LogOff:ThankYou' => 'Спасибо за использование NT3',
	...
	'UI:Login:Error:AccessRestricted' => 'Доступ к NT3 ограничен. Пожалуйста, свяжитесь с администратором NT3.',
	'UI:Login:Error:AccessAdmin' => 'Доступ ограничен для лиц с административными привилегиями. Пожалуйста, свяжитесь с администратором NT3.',
	...
	'UI:Title:BulkImport' => 'NT3 - Пакетный импорт',
	...
	'UI:UniversalSearchTitle' => 'NT3 - Универсальный поиск',
	...
	'UI:RunQuery:Title' => 'NT3 - Оценка запросов OQL',
	...
	'UI:Schema:Title' => 'NT3 схема объектов',
	...
	'UI:WelcomeTont3' => 'Добро пожаловать в NT3',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - %2$s подробности',
	'UI:ErrorPageTitle' => 'NT3 - Ошибка',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - Результаты поиска',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - Изменение объекта %2$s - %1$s',
	'UI:ModificationTitle_Class_Object' => 'Изменение объекта %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - Клон %1$s - %2$s модификация',
	'UI:CloneTitle_Class_Object' => 'Клон %1$s: <span class=\\"hilite\\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - Создание нового %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - Пакетное удаление',
	'UI:BulkDeleteTitle' => 'Выбор объектов для удаления:',
	'UI:PageTitle:ObjectCreated' => 'NT3 Объект создан.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - Критическая ошибка',
	'UI:SystemIntrusion' => 'Доступ запрещён. Вы пытаетесь выполнить неразрешённую операцию.',
	'UI:FatalErrorMessage' => 'Критическая ошибка, NT3 не может продолжать работу.',
	'UI:Error_Details' => 'Ошибка: %1$s.',

	'UI:PageTitle:ClassProjections'	=> 'NT3 управление пользователями - проектирование классов',
	'UI:PageTitle:ProfileProjections' => 'NT3 управление пользователями - проектирование профилей',
	...
	'UI:NotificationsMenu:HelpContent' => '<p>В NT3 уведомления полностью настраиваемые. Они основаны на двух наборах объектов: <i>триггеры</i> и <i>действия</i>.</p>
...
При ассоциации с триггером, каждое действие получает "порядковый" номер, который определяет порядок выполнения действий.</p>',
	...
	'Menu:AuditCategories' => 'Категории аудита', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => 'Категории аудита', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => 'Категории аудита', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:RunQueriesMenu' => 'Выполнение запросов', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => 'Выполнение любых запросов', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:QueryMenu' => 'Книга запросов', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'Книга запросов', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:DataAdministration' => 'Администрирование данных', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => 'Администрирование данных', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:UniversalSearchMenu' => 'Универсальный поиск', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => 'Поиск чего угодно...', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:UserManagementMenu' => 'Управление пользователями', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => 'Управление пользователями', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:ProfilesMenu' => 'Профили пользователей', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => 'Профили пользователей', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'Профили пользователей', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:UserAccountsMenu' => 'Учетные записи пользователей', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => 'Учетные записи пользователей', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'Учетные записи пользователей', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'UI:nt3Version:Short' => '%1$s версия %2$s',
	'UI:nt3Version:Long' => '%1$s версия %2$s-%3$s основан на %4$s',
	...
	'Portal:Title' => 'Пользовательский портал NT3',
	'Portal:NoRequestMgmt' => 'Уважаемый %1$s, вы были перенаправлены на потрал, потому что ваш аккаунт содержит профиль \'Portal user\'. К сожалению, NT3 не содержит модуля \'Request Management\'. Пожалуйста, свяжитесь с вашим администратором.',
...
<tr><td>s</td><td>seconds (2 digits, e.g. 00..59)</td></tr>
	...
	'UI:AboutBox' => 'Об этом NT3...',
	'UI:About:Title' => 'Об этом NT3',
	...
	'portal:backoffice' => 'NT3 Back-Office интерфейс',
