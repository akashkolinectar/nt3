...
Dict::Add('NL NL', 'Dutch', 'Nederlands', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyperlink een (kleine) afbeelding die de applicatie waarmee NT3 is gesynchroniseerd',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hyperlink van de applicatie',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink naar het NT3 object in de externe applicatie waarmee NT3 is gesynchroniseerd (indien toepasbaar). Mogelijke procurators: $this->attribute$ and $replica->primary_key$',
