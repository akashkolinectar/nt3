...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	...
	'Class:UserInternal+' => 'Usuario definido en NT3',
));
...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	'BooleanLabel:yes' => 'si',
	'BooleanLabel:no' => 'no',
	'Menu:WelcomeMenu' => 'Bienvenido', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => 'Bienvenido a NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'Bienvenido', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => 'Bienvenido a NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'Bienvenido a NT3',

	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 es un completo portal de administración de servicios de TI basado en código abierto.</p>
<p>Incluye:</p>
...
<p>Todos los módulos pueden ser configurados, paso a paso, individual e independientemente de los otros.</p>',
	...
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 está orientado a los proveedores de servicios, le permite al personal de TI administrar fácilmente múltiples Organizaciones.
<p>NT3, provee un conjunto de funciones de procesos de negocio que: </p>
...
<p>NT3 es completamente abierto para ser integrado con su actual infraestructura de administración de TI.</p>
<p>
...
<li>Administrar el bien más importante de su infraestructura de TI: La Documentación.</li>
	...
	'UI:Login:Welcome' => 'Bienvenido a NT3',
	...
	'UI:Login:ForgotPwdForm+' => 'NT3 puede enviarle un correo en el cual encontrará las instrucciones a seguir para restablecer su contraseña.',
	...
	'UI:ResetPwd-EmailSubject' => 'Restablecer contraseña de NT3',
	'UI:ResetPwd-EmailBody' => '<body><p>Ha solicitado restablecer su contraseña en NT3.</p><p>Por favor de click en la siguiente liga: <a href="%1$s">proporcione una nueva contraseña</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Gracias por usar NT3',
  ...
  'UI:ChangePwdMenu' => 'Cambiar Contraseña',
	...
	'UI:AccessRO-All' => 'NT3 está en modo de solo lectura',
	'UI:AccessRO-Users' => 'NT3 está en modo de solo lectura para usuarios',
	...
	'UI:Login:Error:AccessRestricted' => 'El acceso a NT3 está restringido. Por favor contacte al Administrador de NT3.',
	'UI:Login:Error:AccessAdmin' => 'Acceso restringido a usuarios con privilegio de administrador. Por favor contacte al Administrador de NT3.',
	...
	'UI:Title:BulkImport' => 'NT3 - Importación por Lotes',
	...
	'UI:UniversalSearchTitle' => 'NT3 - Busqueda Universal',
	...
	'UI:RunQuery:Title' => 'NT3 - Evaluación de consultas OQL',
	...
	'UI:WelcomeTont3' => 'Bienvenido a NT3',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - Detalles %2$s',
	'UI:ErrorPageTitle' => 'NT3 - Error',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - Resultados de la Búsqueda',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - %1$s - %2$s modificación',
	'UI:ModificationTitle_Class_Object' => 'Modificación de %1$s: <span class=\"hilite\">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - Duplicar %1$s - %2$s modificación',
	'UI:CloneTitle_Class_Object' => 'Duplicado de %1$s: <span class=\"hilite\">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - Creación de %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - Eliminar por lote',
	'UI:BulkDeleteTitle' => 'Seleccione los objetos que desea eliminar:',
	'UI:PageTitle:ObjectCreated' => 'Objeto de NT3 creado.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - Error Fatal',
	'UI:FatalErrorMessage' => 'Error fatal, NT3 no puede continuar.',
	...
	'UI:PageTitle:ClassProjections'	=> 'Administración de usuarios NT3 - proyecciones de clases',
	'UI:PageTitle:ProfileProjections' => 'Administración de usuarios NT3 - proyecciones de Perfil',
	...
	'Menu:AdminTools' => 'Herramientas Administrativas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => 'Herramientas Administrativas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => 'Herramientas accesibles sólo a usuarios con Perfil de administrador', // Duplicated into nt3-welcome-itil (will be removed from here...)
...
'UI-ServiceManagementOverview-ProviderContractToRenew' => 'contratos de Proveedores a ser Renovados en 30 días',
	...
	'Menu:CSVImportMenu' => 'Importar CSV', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:CSVImportMenu+' => 'Creación o Actualización Másiva', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:DataModelMenu' => 'Modelo de Datos', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu+' => 'Resumen del Modelo de Datos', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:ExportMenu' => 'Exportar', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu+' => 'Exportar los Resultados de Cualquier Consulta en HTML, CSV o XML', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:NotificationsMenu' => 'Notificaciones', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu+' => 'Configuración de las Notificaciones', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:NotificationsMenu:Title' => 'Configuración de las <span class="hilite">Notificaciones</span>',
	'UI:NotificationsMenu:Help' => 'Ayuda',
	'UI:NotificationsMenu:HelpContent' => '<p>En NT3 las notificaciones son completamente personalizables. Están basadas en dos conjuntos de objetos: <i>Disparadores y Acciones</i>.</p>
...
Cuando se asocien con un disparador, cada acción recibe un número de "orden", esto especifica en que orden se ejecutaran las acciones.</p>',
	...
	'Menu:AuditCategories' => 'Auditar Categorías', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => 'Auditar Categorías', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => 'Auditar Categorías', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:RunQueriesMenu' => 'Ejecutar Consultas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => 'Ejecutar Cualquier Consulta', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:QueryMenu' => 'Libreta de Consultas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'Libreta de Consultas', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:DataAdministration' => 'Administración de Datos', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => 'Administración de Datos', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:UniversalSearchMenu' => 'Búsqueda Universal', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => 'Buscar cualquier cosa', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:UserManagementMenu' => 'Administración de Usuarios', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => 'Administración de Usuarios', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:ProfilesMenu' => 'Perfiles', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => 'Perfiles', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'Perfiles', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:UserAccountsMenu' => 'Cuentas de Usuario', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => 'Cuentas de Usuario', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'Cuentas de Usuario', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'UI:nt3Version:Short' => '%1$s versión %2$s',
	'UI:nt3Version:Long' => '%1$s versión %2$s-%3$s compilada en %4$s',
	...
	'Portal:NoRequestMgmt' => 'Estimado(a) %1$s, ha sido redirigido a esta página porque su cuenta está configurada con el Perfil \'Portal user\'. Desafortunadamente, NT3 no fue instalado con el módulo \'Request Management\'. Por favor contacte a su Administrador.',
	...
	'Portal:ErrorNoContactForThisUser' => 'Error: el Usuario no está asociado con un Contacto/Persona. Por favor contacte al Administrador de NT3',
  'Portal:Attachments' => 'Anexos',
	...
	'UI:AutoApplyConfirmationMessage' => 'Algunos cambios no han sido aplicados todavía. ¿Quiere que NT3 los tome en cuenta?',
  ...
  'UI:UseSpecificSettings' => 'Usar la Siguiente Configuración:',
	...
	'Menu:MyShortcuts' => 'Mis Accesos Rápidos', // Duplicated into nt3-welcome-itil (will be removed from here...)
...
Dict::Add('ES CR', 'Spanish', 'Español, Castellano', array(
	...
	'Class:UserInternal' => 'Usuario Interno',
	'Class:UserInternal+' => 'Usuario definido dentro de NT3',
	...
	'UI:AboutBox' => 'Acerca de NT3...',
	'UI:About:Title' => 'Acerca de NT3',
