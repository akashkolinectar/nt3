...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hiperlink de uma pequena imagem representando o aplicativo com o qual o NT3 é sincronizado',
	'Class:SynchroDataSource/Attribute:url_application' => 'Hiperlink aplicativo',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hiperlink para o objeto na aplicação externa com a qual o NT3 é sincronizado (se aplicável). As substituições possíveis: $this->attribute$ e $replica->primary_key$',
	...
	'Menu:DataSources' => 'Fontes de dados de sincronização', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataSources+' => 'Todas fontes de dados de sincronização', // Duplicated into nt3-welcome-itil (will be removed from here...)
