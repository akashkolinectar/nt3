...
Dict::Add('FR FR', 'French', 'Français', array(
	...
	'Class:UserInternal+' => 'Utilisateur défini dans NT3',
	...
	'Menu:WelcomeMenu' => 'Bienvenue', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => 'Bienvenue dans NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'Bienvenue', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => 'Bienvenue dans NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'Bienvenue dans NT3',
	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 est un portail opérationnel complet et libre pour gérer votre SI.</p>
<ul>il contient:
...
<p>Tous ces modules peuvent être installés séparément, à votre rythme.</p>',
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 a été conçu pour les fournisseurs de service, il permet à vos équipes IT de gérer facilement de multiples clients et organisations.
<ul>NT3 fournit un riche ensemble de processus métier&nbsp;pour:
...
<p>NT3 est complètement ouvert pour s\'intéger avec votre environnement informatique.</p>
<p>
...
<li>Contrôlez l\'actif le plus important de votre SI&nbsp;: la documentation.</li>
	...
	'UI:Error:UploadedFileTooBig' => 'Le fichier téléchargé est trop gros. (La taille maximale autorisée est %1$s). Pour modifier cette limite contactez votre administrateur NT3. (Réglages upload_max_filesize et post_max_size dans la configuration PHP sur le serveur)',
	...
	'UI:Login:Welcome' => 'Bienvenue dans NT3!',
	...
	'UI:ResetPwd-Error-NotPossible' => 'les comptes "externes" ne permettent pas la saisie d\'un mot de passe dans NT3.',
	...
	'UI:ResetPwd-EmailSubject' => 'Changer votre mot de passe NT3',
	'UI:ResetPwd-EmailBody' => '<body><p>Vous avez demandé à changer votre mot de passe NT3 sans connaitre le mot de passe précédent.</p><p>Veuillez suivre le lien suivant (usage unique) afin de pouvoir <a href="%1$s">saisir un nouveau mot de passe</a></p>.',
	...
	'UI:LogOff:ThankYou' => 'Merci d\'avoir utilisé NT3',
	...
	'UI:AccessRO-All' => 'NT3 est en lecture seule',
	'UI:AccessRO-Users' => 'NT3 est en lecture seule pour les utilisateurs finaux',
	...
	'UI:Button:Login' => 'Entrer dans NT3',
	'UI:Login:Error:AccessRestricted' => 'L\'accès à NT3 est soumis à autorisation. Merci de contacter votre administrateur NT3.',
	...
	'UI:Title:BulkImport' => 'NT3 - Import massif',
...
<tr><td>s</td><td>secondes (sur 2 chiffres: 00..59)</td></tr>
	...
	'UI:RunQuery:Title' => 'NT3 - Evaluation de requêtes OQL',
	...
	'UI:Schema:Title' => 'Modèle de données NT3',
	...
	'UI:WelcomeTont3' => 'Bienvenue dans NT3',
	'UI:DetailsPageTitle' => 'NT3 - %2$s - Détails de %1$s',
	'UI:ErrorPageTitle' => 'NT3 - Erreur',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - Résultats de la recherche',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - %2$s - Modification de %1$s',
	'UI:ModificationTitle_Class_Object' => '%1$s - Modification de <span class="hilite">%2$s</span>',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - %2$s - Duplication de %1$s',
	'UI:CloneTitle_Class_Object' => ' %1$s - Duplication de <span class="hilite">%2$s</span>',
	'UI:CreationPageTitle_Class' => 'NT3 - Création d\'un objet de type %1$s ',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - Suppression massive',
	'UI:BulkDeleteTitle' => 'Sélectionnez les objets à supprimer:',
	'UI:PageTitle:ObjectCreated' => 'NT3 objet créé.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - Erreur Fatale',
	'UI:SystemIntrusion' => 'Accès non autorisé. Vous êtes en train de d\'effectuer une opération qui ne vous est pas permise.',
	'UI:FatalErrorMessage' => 'Erreur fatale, NT3 ne peut pas continuer.',
	'UI:Error_Details' => 'Erreur: %1$s.',
	'UI:PageTitle:ClassProjections' => 'NT3 gestion des utilisateurs - projections des classes',
	'UI:PageTitle:ProfileProjections' => 'NT3 gestion des utilisateurs - projections des profils',
	...
	'Menu:AdminTools' => 'Outils d\'admin', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => 'Outils d\'administration', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => 'Ces outils sont accessibles uniquement aux utilisateurs possédant le profil Administrateur.', // Duplicated into nt3-welcome-itil (will be removed from here...)
	...
	'Menu:CSVImportMenu' => 'Import CSV', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:CSVImportMenu+' => 'Import ou mise à jour en masse', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu' => 'Modèle de Données', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu+' => 'Résumé du Modèle de Données', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu' => 'Exportation', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu+' => 'Exportation des résultats d\'une requête en HTML, CSV ou XML', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu' => 'Notifications', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu+' => 'Configuration des Notifications', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:NotificationsMenu:Title' => 'Configuration des <span class="hilite">Notifications</span>',
	'UI:NotificationsMenu:Help' => 'Aide',
	'UI:NotificationsMenu:HelpContent' => '<p>Dans NT3 les notifications sont totalement configurables. Elles sont basées sur deux types d\'objets: <i>déclencheurs et actions</i>.</p>
...
Lors de l\'association à un déclencheur, on attribue à chaque action un numéro d\'ordre, qui définit la séquence des actions à exécuter.</p>',
	...
	'Menu:AuditCategories' => 'Catégories d\'audit', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => 'Catégories d\'audit', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => 'Catégories d\'audit', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu' => 'Requêtes OQL', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => 'Executer une requête OQL', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu' => 'Livre des requêtes', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'Livre des requêtes', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration' => 'Administration des données', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => 'Administration des données', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu' => 'Recherche Universelle', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => 'Rechercher n\'importe quel objet...', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu' => 'Gestion des Utilisateurs', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => 'Gestion des Utilisateurs', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu' => 'Profils', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => 'Profils', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'Profils', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu' => 'Comptes Utilisateurs', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => 'Comptes Utilisateurs', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'Comptes Utilisateurs', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:nt3Version:Short' => '%1$s version %2$s',
	'UI:nt3Version:Long' => '%1$s version %2$s-%3$s du %4$s',
	...
	'Portal:Title' => 'Portail utilisateur NT3',
	'Portal:NoRequestMgmt' => 'Chèr(e) %1$s, vous avez été redirigé(e) vers cette page car votre compte utilisateur est configuré avec le profil \'Utilisateur du Portail\'. Malheureusement, NT3 n\'a pas été installé avec le module de \'Gestion des Demandes\'. Merci de contacter votre administrateur NT3.',
	...
	'Menu:MyShortcuts' => 'Mes raccourcis', // Duplicated into nt3-welcome-itil (will be removed from here...)
	...
	'UI:AboutBox' => 'A propos d\'NT3...',
	'UI:About:Title' => 'A propos d\'NT3',
