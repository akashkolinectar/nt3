...
Dict::Add('PT BR', 'Brazilian', 'Brazilian', array(
	...
	'BooleanLabel:no' => 'Não',
	'Menu:WelcomeMenu' => 'Bem-vindo ao NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => 'Bem-vindo ao NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'Bem-vindo ao NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => 'Bem-vindo ao NT3', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'Bem-vindo ao NT3',

	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 é um completo, OpenSource, portal de operação IT.</p>
<ul>Inclui:
...
<li>gerenciar o ativo mais importante de sua TI: Documentação</li>
	...
	'UI:Error:UploadedFileTooBig' => 'O arquivo a ser carregado é muito grande. (Tamanho máximo permitido é de %1$s). Para modificar esse limite, contate o administrador do NT3. (Verifique a configuração do PHP para upload_max_filesize e post_max_size no servidor).',
	...
	'UI:Login:Welcome' => 'Bem-vindo ao NT3!',
	...
	'UI:Login:ForgotPwdForm+' => 'NT3 pode enviar um e-mail em que você vai encontrar instruções para seguir para redefinir sua conta.',
	...
	'UI:ResetPwd-EmailBody' => '<body><p>Você solicitou a alteração da senha do NT3.</p><p>Por favor, siga este link (passo simples) para <a href="%1$s">digitar a nova senha</a></p>.',
	...
	'UI:WelcomeTont3' => 'Bem-vindo ao NT3',
	...
	'Menu:AdminTools' => 'Ferramentas Administrativas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => 'Ferramentas Administrativas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => 'Ferramentas acessíveis apenas para usuários com o perfil do administrador', // Duplicated into nt3-welcome-itil (will be removed from here...)
...
'UI-ServiceManagementOverview-ProviderContractToRenew' => 'Contratos provedores a serem renovados em 30 dias',
	...
	'Menu:CSVImportMenu+' => 'Criação ou atualização em massa', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:DataModelMenu' => 'Modelo Dados', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataModelMenu+' => 'Visão geral do Modelo Dados', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:ExportMenu' => 'Exportar', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ExportMenu+' => 'Exportar o resultado de qualquer consulta em HTML, CSV ou XML', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:NotificationsMenu' => 'Notificações', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:NotificationsMenu+' => 'Configuração de Notificações', // Duplicated into nt3-welcome-itil (will be removed from here...)
...
When associated with a trigger, each action is given an "order" number, specifying in which order the actions are to be executed.</p>',
	...
	'Menu:AuditCategories' => 'Categoria Auditorias', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => 'Categoria Auditorias', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => 'Categoria Auditorias', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:RunQueriesMenu' => 'Executar consultas', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => 'Executar qualquer consulta', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:QueryMenu' => 'Consulta  definida', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:QueryMenu+' => 'Consulta  definida', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:DataAdministration' => 'Administração Dados', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => 'Administração Dados', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:UniversalSearchMenu' => 'Pesquisa Universal', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => 'Pesquisar por nada...', // Duplicated into nt3-welcome-itil (will be removed from here...)
	
	'Menu:UserManagementMenu' => 'Gerenciamento Usuários', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => 'Gerenciamento Usuários', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:ProfilesMenu' => 'Perfis', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => 'Perfis', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'Perfis', // Duplicated into nt3-welcome-itil (will be removed from here...)

	'Menu:UserAccountsMenu' => 'Contas usuários', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => 'Contas usuários', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'Contas usuários',	 // Duplicated into nt3-welcome-itil (will be removed from here...)

	'UI:nt3Version:Short' => '%1$s versão %2$s',
	'UI:nt3Version:Long' => '%1$s versão %2$s-%3$s construído %4$s',
	...
	'Portal:NoRequestMgmt' => 'Caro %1$ s, você foi redirecionado para esta página porque a sua conta é configurado com o perfil de \'usuário do Portal\'. Infelizmente, NT3 não foi instalado com a função \'Gerenciamento de Solicitações\'. Por favor, contate o administrador.',
...
'Note-se que esta não é uma configuração de segurança, objetos de qualquer organização ainda são visíveis e podem ser acessadas ao selecionar \"Todos Organizações\" na lista drop-down.',
	...
	'Menu:MyShortcuts' => 'Meus atalhos', // Duplicated into nt3-welcome-itil (will be removed from here...)
