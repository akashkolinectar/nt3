...
Dict::Add('HU HU', 'Hungarian', 'Magyar', array(
	...
	'BooleanLabel:no' => 'Nem',
	'Menu:WelcomeMenu' => 'Üdvözlöm', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenu+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage' => 'Üdvözlöm', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:WelcomeMenuPage+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:WelcomeMenu:Title' => 'Üdvözli az NT3',
	'UI:WelcomeMenu:LeftBlock' => '<p>NT3 egy teljeskörű, OpenSource, IT üzemeltetés támogató portál.</p>
...
<p>Mindegyik modul önállóan telepíthető és használható.</p>',
	'UI:WelcomeMenu:RightBlock' => '<p>NT3 egy szolgáltatás orientált megoldás, amely segít az IT szakembereknek több ügyfél és szervezet egyidejű menedzselését.
<ul>az NT3 az üzleti folyamatok javításához egy hatékony eszköz, mert:
...
<p>Az NT3 teljesn nyílt ezért, egyszerűen integrálható a jelenlegi IT infrastruktúrába</p>
<p>
...
<li>hatékonyan tudja kezelni az egyik legfontosabb IT eszközt, a dokumentációt.</li>
	...
	'UI:Login:Welcome' => 'Üdvözli az NT3!',
	...
	'UI:LogOff:ThankYou' => 'Köszönjük, hogy az NT3-ot használja!',
	...
	'UI:AccessRO-All' => 'NT3 csak olvasás módban',
	'UI:AccessRO-Users' => 'NT3 csak olvasás módban a végfelhasználók számára',
	'UI:Login:RetypePwdDoesNotMatch' => 'Az új jelszó és ismételten beírt érték nem egyezik!',
	'UI:Button:Login' => 'Belépés az NT3 alkalmazásba',
	'UI:Login:Error:AccessRestricted' => 'NT3 hozzáférés korlátozva. Kérem forduljon az NT3 adminisztrátorhoz!',
	'UI:Login:Error:AccessAdmin' => 'Adminisztrátori hozzáférés korlátozott. Kérem forduljon az NT3 adminisztrátorhoz!',
	...
	'UI:Title:BulkImport' => 'NT3 - tömeges betöltés',
	'UI:Title:BulkImport+' => '',
	...
	'UI:UniversalSearchTitle' => 'NT3 - Univerzális kereső',
	...
	'UI:RunQuery:Title' => 'NT3 - OQL lekérdezés értékelés',
	...
	'UI:Schema:Title' => 'NT3 objektum séma',
	...
	'UI:WelcomeTont3' => 'Üdvözli az NT3',
	'UI:DetailsPageTitle' => 'NT3 - %1$s - %2$s részletek',
	'UI:ErrorPageTitle' => 'NT3 - Hiba',
	...
	'UI:SearchResultsPageTitle' => 'NT3 - Keresés eredményei',
	...
	'UI:ModificationPageTitle_Object_Class' => 'NT3 - %1$s - %2$s módosítása',
	'UI:ModificationTitle_Class_Object' => '%1$s: <span class=\"hilite\">%2$s</span> módosítása',
	'UI:ClonePageTitle_Object_Class' => 'NT3 - %1$s - %2$s klón módosítása',
	'UI:CloneTitle_Class_Object' => '%1$s: <span class=\"hilite\">%2$s</span> klón',
	'UI:CreationPageTitle_Class' => 'NT3 - %1$s létrehozása',
	...
	'UI:BulkDeletePageTitle' => 'NT3 - Tömeges törlés',
	'UI:BulkDeleteTitle' => 'Válassza ki a törölni kívánt objektumokat:',
	'UI:PageTitle:ObjectCreated' => 'NT3 objektum létrehozva.',
	...
	'UI:PageTitle:FatalError' => 'NT3 - Fatális hiba',
	'UI:SystemIntrusion' => 'Hozzáférés megtagadva. A művelet végrehajtása nem engedélyezett.',
	'UI:FatalErrorMessage' => 'Fatális hiba, NT3 nem tudja a működését folytatni',
	'UI:Error_Details' => 'Hiba: %1$s.',
	'UI:PageTitle:ClassProjections' => 'NT3 felhasználó menedzsmet - osztály nézet',
	'UI:PageTitle:ProfileProjections' => 'NT3 felhasználó menedzsmet - profil nézet',
	...
	'Menu:AdminTools' => 'Adminisztrációs eszközök', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AdminTools?' => 'Eszközök csak az adminisztrátori profilhoz rendlet felhasználók számára elérhetők.', // Duplicated into nt3-welcome-itil (will be removed from here...)
	...
	'Menu:DataModelMenu' => 'Adatmodell', // Duplicated into nt3-welcome-itil (will be removed from here...)
	...
	'Menu:NotificationsMenu' => 'Értesítések', // Duplicated into nt3-welcome-itil (will be removed from here...)
	...
	'UI:NotificationsMenu:HelpContent' => '<p>Az NT3 alkalmazásban az értesítések teljesen testreszabhatók. Értesítések az objektumok két csoportjára épülnek: <i>kiváltó okok és akciók</i>.</p>
...
Akció kiváltó okhoz rendelésekor kap egy sorszámot , amely meghatározza az akciók végrehatási sorrendjét.</p>',
	...
	'Menu:AuditCategories' => 'Audit kategóriák', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:AuditCategories+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:Notifications:Title' => 'Audit kategóriák', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu' => 'Lekérdezés futtatás', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:RunQueriesMenu+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration' => 'Adat adminisztráció', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataAdministration+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu' => 'Univerzális keresés', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UniversalSearchMenu+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu' => 'Felhasználó menedzsment', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserManagementMenu+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu' => 'Profilok', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:ProfilesMenu:Title' => 'Profilok', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu' => 'Felhasználói fiókok', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu+' => '', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:UserAccountsMenu:Title' => 'Felhasználói fiókok', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'UI:nt3Version:Short' => '%1$s verzió: %2$s',
	'UI:nt3Version:Long' => '%1$s verzió: %2$s-%3$s %4$s',
	...
	'Portal:Title' => 'NT3 felhasználói portál',
