...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:SynchroDataSource/Attribute:url_icon+' => 'Hyperlink a (small) image representing the application with which NT3 is synchronized',
	'Class:SynchroDataSource/Attribute:url_application' => 'Application\'s hyperlink',
	'Class:SynchroDataSource/Attribute:url_application+' => 'Hyperlink to the NT3 object in the external application with which NT3 is synchronized (if applicable). Possible placeholders: $this->attribute$ and $replica->primary_key$',
	...
	'Menu:DataSources' => 'Synchronization Data Sources', // Duplicated into nt3-welcome-itil (will be removed from here...)
	'Menu:DataSources+' => 'All Synchronization Data Sources', // Duplicated into nt3-welcome-itil (will be removed from here...)
