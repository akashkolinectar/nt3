...
class NiceWebPage extends WebPage
{
    ...
    public function __construct($s_title, $bPrintable = false)
    {
	    ...
	    /************* Modified by Nilesh For script of google translate ************/
	    $this->add_linked_script(utils::GetAbsoluteUrlAppRoot().'js/translate.js');
	    $this->add_linked_script(utils::GetAbsoluteUrlAppRoot().'js/DTable.js');
	    /************* EOF Modified by Nilesh For script of google translate ************/
	    $this->add_linked_script(utils::GetAbsoluteUrlAppRoot().'js/html2pdf.js');
