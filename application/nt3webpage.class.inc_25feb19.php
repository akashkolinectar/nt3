...
EOF;
            ...
            $sHtml .= ' </div> <!-- /menu -->';
            $sHtml .= ' <div class="footer ui-layout-south"><div id="combodo_logo"><a href='.NT3_HOME.' title='.NT3_HOME.' ><img width="140" src="../images/movicel.jpg?t=' . utils::GetCacheBusterTimestamp() . '"/></a></div></div>';
