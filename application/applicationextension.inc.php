...
/**
 * New extension to add menu items in the "popup" menus inside NT3. Provides a greater flexibility than
 * iApplicationUIExtension::EnumAllowedActions.
 * 
 * To add some menus into NT3, declare a class that implements this interface, it will be called automatically
...
abstract class ApplicationPopupMenuItem
{
	 ...
	 *	Constructor
	 *	
	 * @param string $sUID The unique identifier of this menu in NT3... make sure you pass something unique enough
...
/**
 * Implement this interface to add content to any NT3WebPage
 * 
 ...
 * the specified place and can use the passed NT3WebPage object to add javascript or CSS definitions
 *
 * @package     Extensibility
 * @api
 * @since 2.0  
...
interface iPageUIExtension
{
	 ...
	 * @param NT3WebPage $oPage The page to insert stuff into.
	 * @return string The HTML content to add into the page
	 */
	public function GetNorthPaneHtml(nt3WebPage $oPage);
	/**
	 * Add content to the South pane
	 * @param NT3WebPage $oPage The page to insert stuff into.
	 * @return string The HTML content to add into the page
	 */
	public function GetSouthPaneHtml(nt3WebPage $oPage);
	/**
	 * Add content to the "admin banner"
	 * @param NT3WebPage $oPage The page to insert stuff into.
	 * @return string The HTML content to add into the page
	 */
	public function GetBannerHtml(nt3WebPage $oPage);
}
