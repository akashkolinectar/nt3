...
<div class="ui-layout-content" style="overflow: auto; position: relative; visibility: visible;">
    <h2 style="font-family: Tahoma, Verdana, Arial, Helvetica!important;
		...
		<img src="https://nt3.nectarinfotel.com/images/activityview.png" style="vertical-align:middle;width: 32px;">&nbsp;<?php echo ($jsonData['language']=='PT BR')? 'Criar NDR (Número de registro)':'Create NDR (Número De Registo)' ?></h2>
