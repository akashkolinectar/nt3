...
class nt3PDF extends TCPDF
{
	...
	public function Header()
	{
		...
		// Branding logo
		$sBrandingIcon = APPROOT.'images/nt3-logo.png';
...
class PDFPage extends WebPage
{
	...
	public function __construct($s_title, $sPageFormat = 'A4', $sPageOrientation = 'L')
	{
		...
		$this->oPdf = new nt3PDF($sPageOrientation, 'mm', $sPageFormat, true, 'UTF-8', false);
		
		// set document information
		$this->oPdf->SetCreator(PDF_CREATOR);
		$this->oPdf->SetAuthor('NT3');
