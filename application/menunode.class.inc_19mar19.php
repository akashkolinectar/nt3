...
class ApplicationMenu {
    ...
    static public function DisplayMenu($oPage, $aExtraParams) {
        ...
        foreach (self::$aRootMenus as $aMenu) {
         //if ($aMenu['index'] == 46 || $aMenu['index'] == 0 || $aMenu['index'] == 24) {
            if ($aMenu['rank'] == 10 || $aMenu['rank'] ==35 || $aMenu['rank'] == 80 || $aMenu['rank'] == 42 || $aMenu['rank'] == 50) {
                ...
                /* Remove some submenus of admin tools Stop - Vidya's Code*/
