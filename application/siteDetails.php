<?php
    ...
    $rnc .= "</select><span class='field_input_btn sitebtn site_rnc' style='float:right;padding-top: 10px;' title='Add RNC'><img style='border:0;vertical-align:middle;cursor:pointer;margin-left: 3px;' class='crnc' src='../images/mini_add.gif?t=1538568981.6184'></span><span class='field_input_btn edit_site_rnc'><img id='mini_edit_brand_id' style='border:0;vertical-align:middle;cursor:pointer;' src='../images/wrench.png?t=1538568981.6184'></span>";
...
<div class="ui-layout-content" style="overflow: auto; position: relative; visibility: visible;">
	<h1><img src="https://nt3.nectarinfotel.com/images/addactivity.png" style="vertical-align:middle;width: 32px;">&nbsp; 
	<?php echo ($jsonData['language']=='PT BR')? 'Modificar informações do site':'Modify Site Information' ?> </h1>
...
<button type="button" class="action cancel" onclick="window.location.href='https://nt3.nectarinfotel.com/pages/UI.php?operation=cancel&c[menu]=NewCI&c[feature]=SiteInformation&id=<?php echo $site['site_id'] ?>'"><?php echo ($jsonData['language']=='PT BR')? 'Cancelar':'Cancel' ?></button>&nbsp;&nbsp;&nbsp;&nbsp;
...
<ul>
   <li><a href="#tabs-1"><?php echo ($jsonData['language']=='PT BR')? 'Informação do Site':'Site Information' ?></a></li>
    <li><a href="#tabs-2"><?php echo ($jsonData['language']=='PT BR')? 'Agregados Site':'Aggregate Sites' ?></a></li>
</ul>
...
<div class="details">
<div class="field_container field_small" data-attcode="site_code">
<div class="field_label label"><span title=""><?php echo ($jsonData['language']=='PT BR')? 'Código do site':'Site Code' ?> :</span></div>
<div class="field_data">
<div class="field_value">
<div class="field_value_container">
<div class="attribute-edit">
<div class="field_input_zone field_input_extkey">
	<input type="text" name="site_code" id="site_code" value="<?php echo $site['site_code'] ?>" style="width:210px;" required="">
...
<div class="field_container field_small" data-attcode="site_name">
...
<div class="field_select_wrapper">
	 <span style="float:left">
	 	<input type="text" style="width:210px;" value="<?php echo $site['site_name'] ?>" name="site_name" id="site_name" required=""></span>
...
<div class="field_container field_small" data-attcode="network">
...
<div class="field_container field_small" data-attcode="responsible_area">
<div class="field_label label"><span title=""><?php echo ($jsonData['language']=='PT BR')? 'Área responsável':'Responsible area' ?> :</span></div>
...
<div class="field_container field_small" data-attcode="priority">
...
<div class="field_container field_small" data-attcode="priority_comment">
<div class="field_label label"><span title=""><?php echo ($jsonData['language']=='PT BR')? 'Comentário prioritário':'Priority Comment' ?> :</span></div>
...
<div class="field_select_wrapper">
<span style="float:left">
<textarea name="priority_comment" id="priority_comment" style="width:210px;border: 1px solid #e1e1e1;" value="<?php echo $site['priority_comment']; ?>"><?php echo htmlspecialchars($site['priority_comment']); ?></textarea>
	</span>	
	</div>
</div>
</div></div></div>
...
<div class="details">
<div class="field_container field_small" data-attcode="element_type">
...
<div class="field_container field_small" data-attcode="vendor">
...
<div class="field_container field_small" data-attcode="model">
...
<div class="field_input_zone field_input_extkey" style="width: auto;">
	<select name="province" id="nsite_province" style="width: 210px;">
...
<div class="field_container field_small" data-attcode="municipal">
...
<div class="attribute-edit">
 <div class="field_input_zone field_input_string">
 	<select name="munciple" id="nsite_munciple"  style="width: 210px;">
...
<div class="field_container field_small" data-attcode="locality">
...
<div class="field_input_zone field_input_extkey">
<div class="field_select_wrapper">
	<select name="locality" id="site_locality"  style="width: 210px;">
        <option><?php echo ($jsonData['language']=='PT BR')? 'Selecionar localidade':'Select Locality' ?></option>
        <?php  
             //echo "test"; 
    ...
    <span class='field_input_btn edit_site_locality'>
	<img id='mini_edit_brand_id' style='border:0;vertical-align:middle;cursor:pointer;' src='../images/wrench.png?t=1538568981.6184'></span>

    <span class='field_input_btn sitebtn site_locality' style='padding-top: 10px;' title='Add Locality'>
	<img src='../images/indicator.gif' style='float: right;padding-top: 3px;display:none' id='localityLoad'>
	<img id='mini_add_2_sites' class='clocality' style='border:0;vertical-align:middle;cursor:pointer;' src='../images/mini_add.gif?t=1538568981.6184'></span>
...
<div class="field_container field_small" data-attcode="latitude">
...
<div class="field_select_wrapper">
<span style="float:left">
	<input type="text" name="lat" id="lat" value="<?php echo $site['lat'] ?>" style="width:210px;">
...
<div class="field_container field_small" style="margin-bottom: 27px;" data-attcode="longitude">
...
<div class="field_select_wrapper">
<span style="float:left">
	<input type="text" name="lng" id="lng" value="<?php echo $site['lng'] ?>" style="width:210px;">
</span>	
	</div>
</div>
</div></div></div>
...
<div class="details">
<div class="field_container field_small" data-attcode="phase">
...
<div class="field_container field_small" data-attcode="service_date">
<div class="field_label label">
<span title=""><?php echo ($jsonData['language']=='PT BR')? 'Data de serviço':'Service Date ' ?> :</span></div>
<div class="field_data">
<div class="field_value">
<div class="field_value_container">
<div class="attribute-edit">
...
<div class="field_select_wrapper">
<span style="float:left;">
	<input type="date" name="service_date" id="service_date" value="<?php echo date('Y-m-d',strtotime($site['service_date'])) ?>" style="width:210px;">
...
<div class="field_container field_small" data-attcode="stage">
...
<div class="field_container field_small" data-attcode="sub_stage">
<div class="field_label label">
<span title=""><?php echo ($jsonData['language']=='PT BR')? 'Subestágio':'Sub Stage' ?> :</span></div>
<div class="field_data">
<div class="field_value">
<div class="field_value_container">
<div class="attribute-edit">
...
<div class="field_container field_small" data-attcode="start_date">
...
<div class="field_select_wrapper">
<span style="float:left;">
	<input type="date" name="start_date" id="start_date" value="<?php echo date('Y-m-d',strtotime($site['start_date'])) ?>" style="width:210px;">
										    		</span>
	</div>
</div>
</div></div></div>
...
<div class="field_container field_small" data-attcode="end_date">
...
<div class="field_select_wrapper">
<span style="float:left;">
	<input type="date" name="end_date" id="end_date" value="<?php echo date('Y-m-d',strtotime($site['end_date'])) ?>" style="width:210px;">
									    		</span>
	</div>
</div>
</div></div></div>
...
<div id="tabs-2">
	...
	<table class="listResults siteTbl" id="siteTbl"><thead><tr><th title="Select All / Deselect All">
	<input class="select_all" onclick="CheckAll('#linkedset_sites_list .selection', this.checked);" type="checkbox" value="1" ></th>
		...
		if($result1){
			if($result1->num_rows>0){
				while($aDBInfo = mysqli_fetch_array($result1,MYSQLI_ASSOC)){
					...
					echo "<tr class='tr_".$aDBInfo['site_id']."'><td><input class=\"selection sitemaster\" data-remote-id=\"".$aDBInfo['site_id']."\" data-link-id=\"\" data-unique-id=\"".$i."\" type=\"checkbox\" value=\"".$aDBInfo['site_id']."\" name=\"removesites[]\"> <input type='hidden' name='sites[]' value='".$aDBInfo['site_id']."'> </td><td><a href='https://nt3.nectarinfotel.com/pages/UI.php?operation=cancel&c[menu]=NewCI&c[feature]=SiteInformation&id=".$aDBInfo['site_id']."' target='_change' class='siteDetails' id='".$aDBInfo['site_id']."'>".$aDBInfo['site_code']."</td><td>".$aDBInfo['site_name']."</td><td>".$aDBInfo['province']."</td><td>".$aDBInfo['responsible_area']."</td><td>".date('d M Y (h:i a)',strtotime($aDBInfo['created_date']))."</td></tr>";
	...
	<div id="addAffectedComponentDialog" class="modal">
  		<h1><?php echo ($jsonData['language']=='PT BR')? 'Adicionar Site Agregados':'Add Site Aggregates' ?> </h1>
	...
	<input type="hidden" name="attr_main_sites_list" value="">
  	...
  	<table class="listResults siteTbl" id="siteTblAdd" style="min-width: 900px;"><thead>
	<tr>
	<th title="Select All / Deselect All">
	<input class="select_all aftsitechk" onclick="CheckAll('#linkedset_main_sites_list .selection', this.checked);" type="checkbox" value="1" ></th>
	<th class="header"><?php echo ($jsonData['language']=='PT BR')? 'Código do site':'Site Code' ?></th>
	<th class="header"><?php echo ($jsonData['language']=='PT BR')? 'Nome do site':'Site Name' ?></th>
	<th class="header"><?php echo ($jsonData['language']=='PT BR')? 'Província':'Province' ?></th>
	<th class="header"><?php echo ($jsonData['language']=='PT BR')? 'Área Responsável':'Responsible Area' ?></th>
...
<script type="text/javascript">
   ...
   <div id="edit_modprovince" class="modal">
                                        ...
                                        <div class="field_container field_small">
<div class="field_label label"><span title=""> <?php echo ($jsonData['language']=='PT BR')? 'Province':'Province' ?>  :</span></div>
<div class="field_data">
<div class="field_value">
<div class="field_value_container">
<div class="attribute-edit">
...
<div class="field_input_zone field_input_extkey">
 <span style="float:left"><?php echo $dprovince ?></span>
      ...
      <div id="edit_modmunciple" class="modal">
                                        <h2><?php echo ($jsonData['language']=='PT BR')? 'Editar Municipal':'Edit Munciple' ?></h2>
                                        <div class="details">
<div class="field_container field_small">
<div class="field_label label"><span title=""><?php echo ($jsonData['language']=='PT BR')? 'Província':'Province' ?> :</span></div>
<div class="field_data">
...
<div class="field_input_zone field_input_extkey">
 ...
 <div id="modsubstage" class="modal">
       ...
       <div id="edit_modsubstage" class="modal">
                                        <h2><?php echo ($jsonData['language']=='PT BR')? 'Editar Substage':'Add Priority' ?></h2>
                                        <div class="details">
<div class="field_container field_small">
...
<span style="float:left;"><?php echo $e_rnc ?></span>
	   ...
	   <!-- Locality Modal--->
			                       <div id="modlocality" class="modal">
                                        ...
                                        <div class="details">
                                        <div class="field_container field_small">
                                        <div class="field_label label"><span title=""><?php echo ($jsonData['language']=='PT BR')? 'Adicionar prioridade':'Add Priority' ?>Province :</span></div>
                                        <div class="field_data">
                                        <div class="field_value">
                                        <div class="field_value_container">
                                        <div class="attribute-edit">
                                        ...
                                        <div class="details">
                                        <div class="field_container field_small">
                                        <div class="field_label label"><span title=""><?php echo ($jsonData['language']=='PT BR')? 'Adicionar prioridade':'Add Priority' ?>Munciple :</span></div>
                                        <div class="field_data">
                                        <div class="field_value">
                                        <div class="field_value_container">
                                        <div class="attribute-edit">
		...
		$.ajax({
			...
			success: function(res){
				...
				if(res==2){
					...
					//location.replace("https://nt3dg.nectarinfotel.com/pages/UI.php?operation=cancel&c[menu]=NewCI&c[feature]=SiteInformation&id=<?php //echo $site['site_id'] ?>");
				}
				if(res.flag){
					alert('Site details updated successfully');
					location.replace("https://nt3.nectarinfotel.com/pages/UI.php?operation=cancel&c[menu]=NewCI&c[feature]=SiteInformation&id=<?php echo $site['site_id'] ?>");
				}
			},
			error:function(xhr){
				console.log(xhr);
...
/*$sql = "select * from ntsites where (is_active=1 AND site_id !='".$_POST['site_id']."' AND site_name='".$_POST['site_name']."' AND is_active=1) OR (is_active=1 AND site_code='".$_POST['site_code']."' AND site_id !='".$_POST['site_id']."')";
...
if (FALSE) {
    echo json_encode(2);
			...
			if($result2){
				if(!empty($_POST['network'])){
					foreach ($_POST['network'] as $key => $value) {
						$query3 = "INSERT INTO ntsitenetwork (site_id,network,created_date,is_active) VALUES (".$_POST['site_id'].",'".$value."','".date('Y-m-d H:i:s')."',1)";
		...
		$q1 = "SELECT site_id FROM ntsites WHERE `parent_site`=".$_POST['site_id']." AND is_active=1";
		...
		if($res1){
			if($res1->num_rows>0){
				...
				while($rows1 = mysqli_fetch_array($res1,MYSQLI_ASSOC)){
					array_push($allRec, $rows1['site_id']);
				}

				if(!empty($_POST['sites'])){

					$interSites = array_intersect($_POST['sites'], $allRec);
					$diffSites = array_diff($allRec,$_POST['sites']);
					...
					if(count($interSites)!=count($allRec)){

						foreach ($diffSites as $key => $value) {

							if(in_array($value,$allRec)){
								$query3 = "UPDATE ntsites SET `parent_site`=0 WHERE `site_id`=".$value;
								$result3 = mysqli_query($conf, $query3);
								
								$query4 = "INSERT INTO `ntsitehistory` (`site_id`,`action`,`associated_user`,`finalclass`,`class_id`,`pre_value`,`cur_value`,`created_date`) VALUES ('".$value."','RevokedParent','".$_SESSION['auth_user']."','Site','".$_POST['site_id']."','','','".date('Y-m-d H:i:s')."')";
								$result4 = mysqli_query($conf, $query4);
							}
						}
						/*while($rows1 = mysqli_fetch_array($res1,MYSQLI_ASSOC)){
					
							$query3 = "UPDATE ntsites SET `parent_site`=0 WHERE `site_id`=".$rows1['site_id'];
							$result3 = mysqli_query($conf, $query3);
							
							$query4 = "INSERT INTO `ntsitehistory` (`site_id`,`action`,`associated_user`,`finalclass`,`class_id`,`pre_value`,`cur_value`,`created_date`) VALUES ('".$rows1['site_id']."','RevokedParent','".$_SESSION['auth_user']."','Site','".$_POST['site_id']."','','','".date('Y-m-d H:i:s')."')";
							$result4 = mysqli_query($conf, $query4);
						}*/
		...
		if(!empty($_POST['sites'])){
			...
			foreach ($_POST['sites'] as $key => $value) {
				$query3 = "UPDATE ntsites SET `parent_site`=".$_POST['site_id']." WHERE `site_id`=".$value;
				$result3 = mysqli_query($conf, $query3);
				if(empty($allRec)){
			...
			if(!empty($allRec)){
				$diffSites = array_diff($_POST['sites'],$allRec);
				if(!empty($diffSites)){
					foreach ($diffSites as $key => $value) {
						$query4 = "INSERT INTO `ntsitehistory` (`site_id`,`action`,`associated_user`,`finalclass`,`class_id`,`pre_value`,`cur_value`,`created_date`) VALUES ('".$value."','AssignedParent','".$_SESSION['auth_user']."','Site','".$_POST['site_id']."','','','".date('Y-m-d H:i:s')."')";
						$result4 = mysqli_query($conf, $query4);
		...
		$queryhistory="INSERT INTO `ntsitehistory` (`site_id`,`action`,`associated_user`,`finalclass`,`class_id`,`pre_value`,`cur_value`,`created_date`) VALUES ('".$_POST['site_id']."','Updated','".$_SESSION['auth_user']."','Site','0','','','".date('Y-m-d H:i:s')."')";
