		...
		if ($oStep->RequiresWritableConfig())
		{
			...
			if (file_exists($sConfigFile))
			{
				...
				if (!is_writable($sConfigFile))
				{
					...
					$oP->p("The wizard cannot modify the configuration file for you. If you want to upgrade ".nt3_APPLICATION.", make sure that the file '<b>".realpath($sConfigFile)."</b>' can be modified by the web server.");
