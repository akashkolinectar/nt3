...
class ModuleDiscovery
{
	...
	{
		if (!array_key_exists('nt3_version', $aArgs))
		{
			// Assume 1.0.2
			$aArgs['nt3_version'] = '1.0.2';
		}
...
*/
	...
	/**
	 * Search (on the disk) for all defined NT3 modules, load them and returns the list (as an array)
	 * of the possible NT3 modules to install
	 *
