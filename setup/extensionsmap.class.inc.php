...
/**
 * Helper class to discover all available extensions on a given NT3 system
 */
class nt3ExtensionsMap
{
	/**
	 * The list of all discovered extensions
	 * @param string $sFromEnvironment The environment to scan
	 * @param bool $bNormailizeOldExtension true to "magically" convert some well-known old extensions (i.e. a set of modules) to the new nt3Extension format
	 * @return void
	 */
	...
	public function __construct($sFromEnvironment = 'production', $bNormalizeOldExtensions = true, $aExtraDirs = array())
	{
		...
		{
		    $this->ReadDir($sDir, nt3Extension::SOURCE_REMOTE);
		}
	 ...
	 * where the NT3 files are located
	...
	protected function ScanDisk($sEnvironment)
	{
		...
		{
			if(!$this->ReadDir(APPROOT.'/datamodels/2.x', nt3Extension::SOURCE_WIZARD)) $this->ReadDir(APPROOT.'/datamodels/1.x', nt3Extension::SOURCE_WIZARD);
		}
		$this->ReadDir(APPROOT.'/extensions', nt3Extension::SOURCE_MANUAL);
		$this->ReadDir(APPROOT.'/data/'.$sEnvironment.'-modules', nt3Extension::SOURCE_REMOTE);
	}
	 ...
	 * @param nt3Extension $oNewExtension
	 * @return void
	 */
	protected function AddExtension(nt3Extension $oNewExtension)
	{
	 ...
	 * @param nt3Extension $oExtension
	 * @return NULL|nt3Extension
	 */
	public function IsExtensionObsoletedByAnother(nt3Extension $oExtension)
	{
		...
		{
			if (($oOtherExtension->sSourceDir != $oExtension->sSourceDir) && ($oOtherExtension->sSource != nt3Extension::SOURCE_WIZARD))
			{
	 ...
	 */
	public function NormalizeOldExtensions($sInSourceOnly = nt3Extension::SOURCE_MANUAL)
	{
	 ...
	 * @return boolean
	 */
	public function ModuleIsChosenAsPartOfAnExtension($sModuleNameToFind, $sInSourceOnly = nt3Extension::SOURCE_REMOTE)
	{
		$bChosen = false;
	 ...
	 * @param nt3Extension $oNewExtension
	 */
	protected function ReplaceModulesByNormalizedExtension($aModules, nt3Extension $oNewExtension)
	{
	    foreach($aModules as $sModuleId)
	    {
	    ...
	    return array (
	        ...
	        array (
	            ...
	            array (
	                ...
	                array (
	                    ...
	                    1 => 'nt3-request-template/2.0.0',
	                    2 => 'nt3-request-template-portal/1.0.0',
	                ),
	                '2.0.1' =>
	                array (
	        ...
	        array (
	            ...
	            array (
	                ...
	                array (
	                    ...
	                    1 => 'nt3-standard-email-synchro/2.6.0',
	                ),
	                '2.6.1' =>
	                array (
	                ...
	                array (
	                    0 => 'combodo-email-synchro/2.6.2',
	                    1 => 'nt3-standard-email-synchro/2.6.1',
	                ),
	                '2.6.4' =>
	                array (
	                    0 => 'combodo-email-synchro/2.6.3',
	                    1 => 'nt3-standard-email-synchro/2.6.2',
	                ),
	                '2.6.5' =>
	                array (
	                ...
	                array (
	                    ...
	                    1 => 'nt3-standard-email-synchro/2.6.3',
	                ),
	                '2.6.7' =>
	                array (
	                    0 => 'combodo-email-synchro/2.6.6',
	                    1 => 'nt3-standard-email-synchro/2.6.4',
	                ),
	                '2.6.8' =>
	                array (
	                ...
	                array (
	                    ...
	                    1 => 'nt3-standard-email-synchro/2.6.5',
	                ),
	                '2.6.10' =>
	                array (
	                    0 => 'combodo-email-synchro/2.6.9',
	                    1 => 'nt3-standard-email-synchro/2.6.6',
	                ),
	                '2.6.11' =>
	                array (
	                ...
	                array (
	                    ...
	                    1 => 'nt3-standard-email-synchro/3.0.0',
	                ),
	                '3.0.1' =>
	                array (
	                    0 => 'combodo-email-synchro/3.0.1',
	                    1 => 'nt3-standard-email-synchro/3.0.1',
	                ),
	                '3.0.2' =>
	                array (
	                ...
	                array (
	                    ...
	                    1 => 'nt3-standard-email-synchro/3.0.3',
	                ),
	                '3.0.4' =>
	                array (
	                    0 => 'combodo-email-synchro/3.0.3',
	                    1 => 'nt3-standard-email-synchro/3.0.4',
	                ),
	                '3.0.5' =>
	                array (
	                ...
	                array (
	                    0 => 'combodo-email-synchro/3.0.5',
	                    1 => 'nt3-standard-email-synchro/3.0.5',
	                ),
	            ),
	        ),
	        ...
	        array (
	            ...
	            array (
	                '1.0.0' =>
	                array (
	                    0 => 'nt3-object-copier/1.0.0',
	                ),
	                '1.0.1' =>
	                array (
	                    0 => 'nt3-object-copier/1.0.1',
	                ),
	                '1.0.2' =>
	                array (
	                    0 => 'nt3-object-copier/1.0.2',
	                ),
	                '1.0.3' =>
	                array (
	                    0 => 'nt3-object-copier/1.0.3',
	                ),
	                '1.1.0' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.0',
	                ),
	                '1.1.1' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.1',
	                ),
	                '1.1.2' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.2',
	                ),
	                '1.1.3' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.3',
	                ),
	                '1.1.4' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.4',
	                ),
	                '1.1.5' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.5',
	                ),
	                '1.1.6' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.6',
	                ),
	                '1.1.7' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.7',
	                ),
	                '1.1.8' =>
	                array (
	                    0 => 'nt3-object-copier/1.1.8',
	                ),
	            ),
	        ),
