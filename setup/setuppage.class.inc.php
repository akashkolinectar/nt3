...
h3.clickable.open {
	...
	{
		$this->s_content = "<div id=\"header\"><h1><a href=\"".NT3_HOME."\" target=\"_blank\"><img title=\"NT3\" src=\"../images/nt3-logo.png?t=".utils::GetCacheBusterTimestamp()."\"></a>&nbsp;".htmlentities($this->s_title, ENT_QUOTES, 'UTF-8')."</h1>\n</div><div id=\"setup\">{$this->s_content}\n</div>\n";
