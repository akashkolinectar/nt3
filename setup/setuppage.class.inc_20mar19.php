...
p.info {
	padding-left: 50px;
	background: url(../images/info-mid.png) no-repeat left 0px;
	min-height: 48px;
}
p.ok {
	padding-left: 50px;
...
p.warning {
	padding-left: 50px;
	background: url(../images/messagebox_warning-mid.png) no-repeat left 0px;
	min-height: 48px;
}
p.error {
	padding-left: 50px;
	background: url(../images/stop-mid.png) no-repeat left 0px;
	min-height: 48px;
}
td.label {
	text-align: left;
...
h3.clickable.open {
	...
	{
		$this->s_content = "<div id=\"header\"><h1><a href=\"http://nt3.nectarinfotel.com\" target=\"_blank\"><img title=\"NT3\" src=\"../images/nt3-logo.png?t=".utils::GetCacheBusterTimestamp()."\"></a>&nbsp;".htmlentities($this->s_title, ENT_QUOTES, 'UTF-8')."</h1>\n</div><div id=\"setup\">{$this->s_content}\n</div>\n";
