	...
	public function Render()
	{
		...
		if (!$this->oField->GetReadOnly() && !$this->oField->GetHidden())
		{
			...
			switch ($sFieldClass)
			{
                ...
                case 'Combodo\\nt3\\Form\\Field\\MultipleSelectField':
                    // Opening container
...
EOF
				...
				case 'Combodo\\nt3\\Form\\Field\\RadioField':
				case 'Combodo\\nt3\\Form\\Field\\CheckboxField':
					$sFieldType = ($sFieldClass === 'Combodo\\nt3\\Form\\Field\\RadioField') ? 'radio' : 'checkbox';
...
EOF
		...
		else
		{
			...
			if (($this->oField instanceof Combodo\nt3\Form\Field\MultipleChoicesField) && ($this->oField->GetMultipleValuesEnabled()))
			{
				// TODO
			}
				...
				switch ($sFieldClass)
				{
                    ...
                    case 'Combodo\\nt3\\Form\\Field\\DurationField':
						...
						if (!$this->oField->GetHidden())
						{
                            ...
                            // Value
                            $bEncodeHtmlEntities = ( in_array($sFieldClass, array('Combodo\\nt3\\Form\\Field\\UrlField', 'Combodo\\nt3\\Form\\Field\\EmailField', 'Combodo\\nt3\\Form\\Field\\PhoneField')) ) ? false : true;
                            $oOutput->AddHtml('<div class="form_field_control">');
                        ...
                        if($sFieldClass !== 'Combodo\\nt3\\Form\\Field\\LabelField')
                        {
                            $sValueForInput = ($sFieldClass === 'Combodo\\nt3\\Form\\Field\\DateTimeField') ? $this->oField->GetDisplayValue() : $this->oField->GetCurrentValue();
