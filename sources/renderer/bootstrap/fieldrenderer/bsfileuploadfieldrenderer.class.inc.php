...
class BsFileUploadFieldRenderer extends FieldRenderer
{
	...
	public function Render()
	{
		...
		// TODO : Add max upload size when NT3 attachment has been refactored
		...
		// JS for file upload
		// Note : This is based on nt3-attachement/main.attachments.php
		$oOutput->AddJs(
<<<EOF
			...
			// Note : This is inspired by nt3-attachments/main.attachments.php
	...
	protected function PrepareExistingFiles(RenderingOutput &$oOutput)
	{
		...
		else
		{
			while ($oAttachment = $oSet->Fetch())
			{
				...
				$sIcon = utils::GetAbsoluteUrlAppRoot() . 'env-' . utils::GetCurrentEnvironment() . '/nt3-attachments/icons/image.png';
